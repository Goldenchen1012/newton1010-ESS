...
#line 18 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
#line 19 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
#line 20 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
#line 21 "..\\..\\..\\API\\ApiEventFlashRom.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 22 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
#line 23 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
#line 24 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
#line 25 "..\\..\\..\\API\\ApiEventFlashRom.c"
...
{
	if(calEventLogCheckSum(pBuf) == 0xA5)
		return 1;
	return 0;
}
static void searchLastRecordAddress(void)
{
	...
	{
		if(mEventLog.LastAddress <= (0x08000000L + (400 * 1024L)))
		{
			mEventLog.LastAddress = (0x08000000L + (400 * 1024L));
			mEventLog.RecordAddressValid = LOG_ADDR_CHECKING;			
		}
		else
		{
...
static void searchLastLogAddressSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{	
	char str[100];
	...
	else if(evt == LIB_SW_TIMER_EVT_SW_10MS_8)
	{
		...
		if(mEventLog.RecordAddressValid == LOG_ADDR_CHECKING)
		{
			if(isFinishWriteEventLogTempData())
			{
				...
				appSerialCanDavinciSendTextMessage(str);
				appSerialCanDavinciSendTextMessage("Finish temp log data save....");
			}
		}		
	}
}
...
{
	uint32_t 	num;
	num = mEventLog.LastAddress - (0x08000000L + (400 * 1024L));
	num /= 8;
	return num;
}
void apiEventLogReadLogData(uint32_t EvetIdex, uint8_t ReadNumber, tApiEventLogCallbackFunction CbFunction)
{
	...
	mHalEeProm.StartAddress = (0x08000000L + (400 * 1024L)) + EvetIdex * 8;
...
void apiEventLogSaveLogData(uint8_t EventType, uint16_t Par)
{
	...
	{
		appSerialCanDavinciSendTextMessage("Can't Save Event Log");
		return;	
	}
...
void apiEventLogOpen(void)
{
	...
	mEventLog.LastAddress = (0x08000000L + (500 * 1024L)) - 256;
	LibSwTimerOpen(searchLastLogAddressSwTimerHandler, 0);
}
