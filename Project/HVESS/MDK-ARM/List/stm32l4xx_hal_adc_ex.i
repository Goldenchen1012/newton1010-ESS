...
#line 44 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc_ex.c"
...
#line 399 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc_ex.c"
...
#line 765 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc_ex.c"
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef *hadc, uint32_t *pData, uint32_t Length)
{
  ...
  else
  {
    ...
    ( (((hadc)->Instance == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL)))) ? ((&tmphadcSlave)->Instance = ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040100UL))) : ((&tmphadcSlave)->Instance = 0) );
    ...
    if (tmp_hal_status == HAL_OK)
    {
      ...
      tmpADC_Common = (((ADC_Common_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040300UL)));
...
#line 1935 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc_ex.c"
    }
    else
    {
