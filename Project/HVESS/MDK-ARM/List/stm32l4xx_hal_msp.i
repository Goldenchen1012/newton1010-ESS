...
#line 40 "..\\..\\..\\User\\stm32l4xx_hal_msp.c"
#line 41 "..\\..\\..\\User\\stm32l4xx_hal_msp.c"
#line 42 "..\\..\\..\\User\\stm32l4xx_hal_msp.c"
...
{  
	...
	if(hi2c->Instance == ((I2C_TypeDef *) ((0x40000000UL) + 0x5400UL))){
		...
		((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) |= ((0x1UL << (21U))));
		((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) &= ~((0x1UL << (21U))));		
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef *hi2c)
{
	...
	if(hi2c->Instance == ((I2C_TypeDef *) ((0x40000000UL) + 0x5400UL))){	
		...
		HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0100));
		 
		HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0080));
...
#line 220 "..\\..\\..\\User\\stm32l4xx_hal_msp.c"
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim)
{
	...
	}else if(htim->Instance == ((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL))){
	...
	}else if(htim->Instance == ((TIM_TypeDef *) ((0x40000000UL) + 0x0800UL))){
		do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (2U)))); (void)tmpreg; } while(0);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef *htim){
	if(htim->Instance == ((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL))){
		...
		((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) &= ~((0x1UL << (2U))));
	}
}
