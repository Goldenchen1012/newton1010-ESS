...
#line 183 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
...
#line 305 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
    ...
    if (status == HAL_OK)
    {
      ...
      hrtc->Instance->CR &= ~((0x1UL << (6U)) | (0x3UL << (21U)) | (0x1UL << (20U)));
      ...
      if (status == HAL_OK)
      {
        ...
        hrtc->Instance->OR &= ~((0x1UL << (0U)) | (0x1UL << (1U)));
...
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef *hrtc)
{
  ...
  if (hrtc != 0)
  {
    ...
    if (status == HAL_OK)
    {
      ...
      hrtc->Instance->PRER = ((uint32_t)((0x7FUL << (16U)) | 0x000000FFU));
...
#line 444 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
...
#line 689 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
...
#line 1431 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
...
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  if (status == HAL_OK)
  {
    ...
    hrtc->Instance->TR = (uint32_t)(tmpreg & ((0x1UL << (22U)) | (0x3UL << (20U)) | (0xFUL << (16U)) | (0x7UL << (12U)) | (0xFUL << (8U))| (0x7UL << (4U)) | (0xFUL << (0U))));
...
#line 1781 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
  }
  else
  {
    if ((hrtc->Instance->CR & (0x1UL << (6U))) != 0U)
...
#line 1809 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
...
#line 1816 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
  }
  ...
  if (sAlarm->Alarm == (0x1UL << (8U)))
  {
    ...
    ((hrtc)->Instance ->ISR = (~(((0x1UL << (8U))) | (0x1UL << (7U)))|((hrtc)->Instance ->ISR & (0x1UL << (7U)))));
    ...
    while ((((((hrtc)->Instance ->ISR) & ((0x1UL << (0U)))) != 0U) ? 1U : 0U) == 0U)
    {
  ...
  else
  {
    ...
    while ((((((hrtc)->Instance ->ISR) & ((0x1UL << (1U)))) != 0U) ? 1U : 0U) == 0U)
    {
      if ((HAL_GetTick() - tickstart) > 1000u)
      {
...
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if (Format == 0x00000000u)
  {
    ...
    tmpreg = (((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Hours) << (16U)) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Minutes) << (8U)) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Seconds) << (0U)) |               ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << (22U)) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmDateWeekDay) << (24U)) |               ((uint32_t)sAlarm->AlarmDateWeekDaySel) |               ((uint32_t)sAlarm->AlarmMask));
#line 1969 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
  }
  else
  {
    if ((hrtc->Instance->CR & (0x1UL << (6U))) != 0U)
...
#line 1997 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
    tmpreg = (((uint32_t)(sAlarm->AlarmTime.Hours) << (16U)) |               ((uint32_t)(sAlarm->AlarmTime.Minutes) << (8U)) |               ((uint32_t)(sAlarm->AlarmTime.Seconds) << (0U)) |               ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << (22U)) |               ((uint32_t)(sAlarm->AlarmDateWeekDay) << (24U)) |               ((uint32_t)sAlarm->AlarmDateWeekDaySel) |               ((uint32_t)sAlarm->AlarmMask));
#line 2004 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
  }
  ...
  (((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->IMR1 |= (0x1UL << (18U)));
  (((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->RTSR1 |= (0x1UL << (18U)));
...
void HAL_RTC_DST_Add1Hour(RTC_HandleTypeDef *hrtc)
{
  (void)hrtc;
  do{ (hrtc)->Instance ->WPR = 0xCAU; (hrtc)->Instance ->WPR = 0x53U; } while(0u);
  ((((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL))->CR) |= ((0x1UL << (16U))));
  do{ (hrtc)->Instance ->WPR = 0xFFU; } while(0u);
}
...
void HAL_RTC_DST_Sub1Hour(RTC_HandleTypeDef *hrtc)
{
  (void)hrtc;
  do{ (hrtc)->Instance ->WPR = 0xCAU; (hrtc)->Instance ->WPR = 0x53U; } while(0u);
  ((((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL))->CR) |= ((0x1UL << (17U))));
  do{ (hrtc)->Instance ->WPR = 0xFFU; } while(0u);
}
...
void HAL_RTC_DST_SetStoreOperation(RTC_HandleTypeDef *hrtc)
{
  (void)hrtc;
  do{ (hrtc)->Instance ->WPR = 0xCAU; (hrtc)->Instance ->WPR = 0x53U; } while(0u);
  ((((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL))->CR) |= ((0x1UL << (18U))));
  do{ (hrtc)->Instance ->WPR = 0xFFU; } while(0u);
}
...
{
  (void)hrtc;
  return ((((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL))->CR) & ((0x1UL << (18U))));
}
...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef *hrtc)
{
  ...
  (((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 = (0x1UL << (18U)));

#line 2376 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"

   
  if ((((((hrtc)->Instance ->CR) & ((0x1UL << (12U)))) != 0U) ? 1U : 0U) != 0U)
  {
     
    if ((((((hrtc)->Instance ->ISR) & ((0x1UL << (8U)))) != 0U) ? 1U : 0U) != 0U)
    {
  ...
  if ((((((hrtc)->Instance ->CR) & ((0x1UL << (13U)))) != 0U) ? 1U : 0U) != 0U)
  {
     
    if ((((((hrtc)->Instance ->ISR) & ((0x1UL << (9U)))) != 0U) ? 1U : 0U) != 0U)
    {
...
HAL_StatusTypeDef HAL_RTC_PollForAlarmAEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while ((((((hrtc)->Instance ->ISR) & ((0x1UL << (8U)))) != 0U) ? 1U : 0U) == 0U)
  {
...
HAL_StatusTypeDef HAL_RTC_WaitForSynchro(RTC_HandleTypeDef *hrtc)
{
  ...
  hrtc->Instance->ISR &= (uint32_t)(~((0x1UL << (7U)) | (0x1UL << (5U))));
  ...
  while ((hrtc->Instance->ISR & (0x1UL << (5U))) == 0U)
...
#line 2596 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_rtc.c"
  if ((hrtc->Instance->ISR & (0x1UL << (6U))) == 0U)
  {
    ...
    while ((((hrtc->Instance ->ISR) & ((0x1UL << (6U)))) == 0U) && (status != HAL_TIMEOUT))
    {
      if ((HAL_GetTick()  - tickstart) > 1000u)
      {
        status = HAL_TIMEOUT;
...
HAL_StatusTypeDef RTC_ExitInitMode(RTC_HandleTypeDef *hrtc)
{
  ...
  ((((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL))->ISR) &= ~((0x1UL << (7U))));


   
  if (((((RTC_TypeDef *) ((0x40000000UL) + 0x2800UL))->CR) & ((0x1UL << (5U)))) == 0U)
  {
