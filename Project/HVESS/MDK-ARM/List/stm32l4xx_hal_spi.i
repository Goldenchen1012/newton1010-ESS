...
#line 203 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_spi.c"
...
#line 394 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_spi.c"
...
#line 433 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_spi.c"
  ...
  if (hspi->Init.CRCCalculation == (0x1UL << (13U)))
  {
    ...
    if (hspi->Init.CRCLength == (0x00000002U))
    {
      ((hspi->Instance ->CR1) |= ((0x1UL << (11U))));
    }
  }
  ...
  if (hspi->Init.CRCCalculation == (0x1UL << (13U)))
  {
    ((hspi->Instance ->CRCPR) = ((hspi->Init . CRCPolynomial & (0xFFFFUL << (0U)))));
  }
...
#line 516 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_spi.c"
...
#line 777 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_spi.c"
...
HAL_StatusTypeDef HAL_SPI_Receive(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hspi->Init.CRCCalculation == (0x1UL << (13U)))
  {
    ...
    if (hspi->Init.DataSize == (0x00000F00U))
    {
    ...
    else
    {
      ...
      if ((hspi->Init.DataSize == (0x00000700U)) && (hspi->Init.CRCLength == (0x00000002U)))
      {
        if (SPI_WaitFlagStateUntilTimeout(hspi, (0x1UL << (0U)), SET, Timeout, tickstart) != HAL_OK)
        {
                                          ...
                                          uint32_t Timeout)
{
  ...
  spi_cr1             = ((hspi->Instance ->CR1));
  spi_cr2             = ((hspi->Instance ->CR2));
    ...
    while ((hspi->TxXferCount > 0U) || (hspi->RxXferCount > 0U))
    {
      ...
      if ((((((hspi)->Instance ->SR) & ((0x1UL << (1U)))) == ((0x1UL << (1U))))) && (hspi->TxXferCount > 0U) && (txallowed == 1U))
      {
        ...
        if ((hspi->TxXferCount == 0U) && (hspi->Init.CRCCalculation == (0x1UL << (13U))))
        {
          ...
          if ((((spi_cr1) & ((0x1UL << (2U)))) == 0U) && (((spi_cr2) & ((0x1UL << (3U)))) == (0x1UL << (3U))))
          {
            ((hspi->Instance ->CR1) |= ((0x1UL << (9U))));
          }
          ((hspi->Instance ->CR1) |= ((0x1UL << (12U))));
        }
...
static void SPI_DMATransmitReceiveCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((hdma->Instance->CCR & (0x1UL << (5U))) != (0x1UL << (5U)))
  {
    ...
    if (hspi->Init.CRCCalculation == (0x1UL << (13U)))
    {
      if ((hspi->Init.DataSize == (0x00000700U)) && (hspi->Init.CRCLength == (0x00000001U)))
      {
        if (SPI_WaitFifoStateUntilTimeout(hspi, (0x3UL << (9U)), (0x00000200U), 100U,
                                          tickstart) != HAL_OK)
        {
      ...
      {
        if (SPI_WaitFifoStateUntilTimeout(hspi, (0x3UL << (9U)), (0x00000400U), 100U, tickstart) != HAL_OK)
        {
