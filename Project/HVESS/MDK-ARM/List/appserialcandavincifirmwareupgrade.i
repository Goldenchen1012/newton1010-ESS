...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 1 "..\\..\\..\\HAL\\HalRtc.h"
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
#line 30 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 1 "..\\..\\..\\APP\\AppBms.h"
...
#line 31 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
#line 1 "..\\..\\..\\API\\ApiFu.h"
...
#line 32 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.c"
...
void FuCallbackFunction(uint16_t evt, uint8_t *pMsgBuf)
{
	...
	case API_FU_EVT_PROGRESS:
		CanPkg.id = (((uint32_t)0x0D<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x03);
	...
	case API_FU_EVT_CHECK_RESULT:
		CanPkg.id = (((uint32_t)0x0D<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x04);
...
static void decodeFuInfoPackage(smp_can_package_t *pCanPkg)
{
	...
	{
	case 0x01:
		n1 = ((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
	...
	case 0x02:
		...
		n1 = ((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
		n2 = ((((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+0)))));
	...
	case 0x05:
		...
		{
			appSerialCanDavinciSendTextMessage("Check & Update");	
			apiFuUpdateFw();
		}
		break;
	case 0x06:
		...
		{
			appSerialCanDavinciSendTextMessage("Reset And Update");
			apiFuResetAndUpdate();
		}
		break;
	case 0x07:
		...
		{
			appSerialCanDavinciSendTextMessage("App Reset");	
			apiFuResetApp();
		}
		break;
	case 0x08:
...
static void decodeFuDataPackage(smp_can_package_t *pCanPkg)
{
	...
	objindex = ((pCanPkg->id >> 10) & 0xff);
	subindex = (pCanPkg->id & 0x3ff);
	



	address = objindex - 0x01;
	address *= 8192L;
