...
#line 20 "..\\..\\..\\Drivers\\SMP\\smp_gpio.c"
...
#line 21 "..\\..\\..\\Drivers\\SMP\\smp_gpio.c"

 
 
 
#line 34 "..\\..\\..\\Drivers\\SMP\\smp_gpio.c"
...
int8_t smp_gpio_init(smp_gpio_t *p_gpio)
{
	...
	do { if((p_gpio->port) == SMP_GPIOA) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0);} else if((p_gpio->port) == SMP_GPIOB) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (1U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (1U)))); (void)tmpreg; } while(0);} else if((p_gpio->port) == SMP_GPIOC) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (2U)))); (void)tmpreg; } while(0);} else if((p_gpio->port) == SMP_GPIOD) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (3U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (3U)))); (void)tmpreg; } while(0);} else if((p_gpio->port) == SMP_GPIOE) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (4U)))); (void)tmpreg; } while(0);} else if((p_gpio->port) == SMP_GPIOF) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (5U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (5U)))); (void)tmpreg; } while(0);} else if((p_gpio->port) == SMP_GPIOG) {do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (6U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (6U)))); (void)tmpreg; } while(0); HAL_PWREx_EnableVddIO2();} } while(0);
...
{
	switch(mode){
		case (0x00000000u):									return (0x00000000u);
		case SMP_GPIO_MODE_OUTPUT_PP:					return (0x00000001u);
		default:
		case SMP_GPIO_MODE_OUTPUT_OD:					return (0x00000011u);
		case SMP_GPIO_MODE_ANALOG:						return (0x00000003u);
		case SMP_GPIO_MODE_IT_RISING:					return (0x10110000u);
		case SMP_GPIO_MODE_IT_FALLING:				return (0x10210000u);
		case SMP_GPIO_MODE_IT_RISING_FALLING:	return (0x10310000u);
	}
}
...
uint16_t SMP_GPIO_PIN(gpio_pin pin)
{
	switch(pin){
		default:
		case PIN0:	return ((uint16_t)0x0001);
		case PIN1:	return ((uint16_t)0x0002);
		case PIN2:	return ((uint16_t)0x0004);
		case PIN3:	return ((uint16_t)0x0008);
		case PIN4:	return ((uint16_t)0x0010);
		case PIN5:	return ((uint16_t)0x0020);
		case PIN6:	return ((uint16_t)0x0040);
		case PIN7:	return ((uint16_t)0x0080);
		case PIN8:	return ((uint16_t)0x0100);
		case PIN9:	return ((uint16_t)0x0200);
		case PIN10:	return ((uint16_t)0x0400);
		case PIN11:	return ((uint16_t)0x0800);
		case PIN12:	return ((uint16_t)0x1000);
		case PIN13:	return ((uint16_t)0x2000);
		case PIN14:	return ((uint16_t)0x4000);
		case PIN15:	return ((uint16_t)0x8000);			
	}
}
...
GPIO_TypeDef* SMP_GPIO_PORT(gpio_port port)
{
	switch(port){
		default:
		case SMP_GPIOA:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL));
		case SMP_GPIOB:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL));
		case SMP_GPIOC:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL));
		case SMP_GPIOD:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0C00UL));
		case SMP_GPIOE:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL));
		case SMP_GPIOF:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL));
		case SMP_GPIOG:	return ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1800UL));
	}
}
