...
#line 25 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\HAL\\halUart.h"
...
int8_t HalUartTx(tHalUart *pHalUart, uint8_t *pSendBuf, uint16_t leng);
int8_t HalUartOpen(tHalUart *pHalUart);
int8_t HalUartClose(tHalUart *pHalUart);
...
#line 21 "..\\..\\..\\HAL\\HalCan.h"
#line 22 "..\\..\\..\\HAL\\HalCan.h"
...
int8_t HalCanOpen(tHalCan *pHalCan);
...
int8_t HalRtcOpen(void);
int8_t HalRtcClose(void);
int8_t HalRtcSetupDate(uint16_t year, uint8_t mon, uint8_t day);
int8_t HalRtcSetupTime(uint8_t hour, uint8_t min, uint8_t sec);
...
#line 30 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\HAL\\HalEeprom.h"
...
#line 21 "..\\..\\..\\HAL\\HalEeprom.h"
#line 22 "..\\..\\..\\HAL\\HalEeprom.h"
...
int8_t HalEePromWrite(tHalEeProm *pEeProm);
int8_t HalEePromErase(tHalEeProm *pEeProm);
int8_t HalEePromRead(tHalEeProm *pEeProm);
...
#line 35 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\AppCommunication\\AppSerialUartDavinci.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialUartDavinci.h"
...
#line 36 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\APP\\AppBalance.h"
...
void appBalanceOpen(tLibRegisterEvtHandler );
...
#line 38 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\API\\ApiSignalFeedback.h"
...
#line 21 "..\\..\\..\\API\\ApiSignalFeedback.h"
...
void apiSignalFeedbackOpen(tLibRegisterEvtHandler evtHandler);
...
#line 40 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\Lib\\LibData.h"
...
#line 41 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\API\\ApiRamData.h"
...
#line 42 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 43 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 44 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\API\\ApiRelayControl.h"
...
#line 21 "..\\..\\..\\API\\ApiRelayControl.h"
#line 22 "..\\..\\..\\API\\ApiRelayControl.h"
...
#line 40 "..\\..\\..\\API\\ApiRelayControl.h"

#line 56 "..\\..\\..\\API\\ApiRelayControl.h"





#line 80 "..\\..\\..\\API\\ApiRelayControl.h"

#line 128 "..\\..\\..\\API\\ApiRelayControl.h"
...
#line 46 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\API\\ApiScuTemp.h"
...
#line 47 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\API\\ApiSystemFlag.h"
...
#line 59 "..\\..\\..\\API\\ApiSystemFlag.h"

#line 84 "..\\..\\..\\API\\ApiSystemFlag.h"
...
#line 49 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\API\\ApiEventLog.h"
...
#line 50 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\APP\\SmpEventType.h"
...
#line 51 "..\\..\\..\\APP\\AppProjectHvEss.c"
#line 1 "..\\..\\..\\APP\\AppButton.h"
...
#line 21 "..\\..\\..\\APP\\AppButton.h"
#line 22 "..\\..\\..\\APP\\AppButton.h"
...
void appButtonOpen(tLibRegisterEvtHandler EventHandler);
...
static void protectEventHandler(void *pDest, uint16_t evt, void *pData)
{
	...
	case APP_PROTECT_OVP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_OVP_L1_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_OVP_L2_SET:
		apiEventLogSaveLogData(EVENT_TYPE_OVP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_OVP_L3_SET:
		relayOff();
		appSerialCanDavinciSendTextMessage("OVP L3 set");
		apiEventLogSaveLogData(EVENT_TYPE_OVP_L3_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_OVP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_OVP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_OVP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_OVP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_OVP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_OVP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_UVP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_UVP_L1_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_UVP_L2_SET:
		apiEventLogSaveLogData(EVENT_TYPE_UVP_L2_SET, libGetUint16((uint8_t *)pData));	
		break;
	case APP_PROTECT_UVP_L3_SET:
		apiEventLogSaveLogData(EVENT_TYPE_UVP_L3_SET, libGetUint16((uint8_t *)pData));
		relayOff();
		break;
	case APP_PROTECT_UVP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_UVP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_UVP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_UVP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_UVP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_UVP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		relayOff();
		break;
	case APP_PROTECT_COTP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L1_SET, libGetUint16((uint8_t *)pData));
		break;	
	case APP_PROTECT_COTP_L2_SET:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COTP_L3_SET:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L3_SET, libGetUint16((uint8_t *)pData));
		relayOff();
		break;
	case APP_PROTECT_COTP_L4_SET:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L4_SET, libGetUint16((uint8_t *)pData));
		relayOff();
		break;
	case APP_PROTECT_COTP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COTP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COTP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COTP_L4_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COTP_L4_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_CUTP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L1_SET, libGetUint16((uint8_t *)pData));
		break;	
	case APP_PROTECT_CUTP_L2_SET:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_CUTP_L3_SET:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L3_SET, libGetUint16((uint8_t *)pData));
		relayOff();
		break;
	case APP_PROTECT_CUTP_L4_SET:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L4_SET, libGetUint16((uint8_t *)pData));
		relayOff();
		break;
	case APP_PROTECT_CUTP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_CUTP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_CUTP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_CUTP_L4_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_CUTP_L4_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOTP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_DOTP_L1_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOTP_L2_SET:		
		apiEventLogSaveLogData(EVENT_TYPE_DOTP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOTP_L3_SET:
		relayOff();
		apiEventLogSaveLogData(EVENT_TYPE_DOTP_L3_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOTP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOTP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOTP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOTP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOTP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOTP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DUTP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_DUTP_L1_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DUTP_L2_SET:		
		apiEventLogSaveLogData(EVENT_TYPE_DUTP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DUTP_L3_SET:
		relayOff();
		apiEventLogSaveLogData(EVENT_TYPE_DUTP_L3_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DUTP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DUTP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DUTP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DUTP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DUTP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DUTP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L1_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L2_SET:
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L3_SET:
		relayOff();
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L3_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L4_SET:
		relayOff();
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L4_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_DOCP_L4_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_DOCP_L4_RELEASE, libGetUint16((uint8_t *)pData));
		break;	
	case APP_PROTECT_COCP_L1_SET:
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L1_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L2_SET:	
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L2_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L3_SET:
		relayOff();
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L3_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L4_SET:
		relayOff();
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L4_SET, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L1_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L1_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L2_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L2_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L3_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L3_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_COCP_L4_RELEASE:
		apiEventLogSaveLogData(EVENT_TYPE_COCP_L4_RELEASE, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_OVP_PF:
		relayOff();
		apiSysParOvpPfSet();
		apiEventLogSaveLogData(EVENT_TYPE_OVP_PF, libGetUint16((uint8_t *)pData));
		break;
	case APP_PROTECT_UVP_PF:
		relayOff();
		apiSysParUvpPfSet();
		apiEventLogSaveLogData(EVENT_TYPE_UVP_PF, libGetUint16((uint8_t *)pData));
		break;
	}
}
...
static void afeEventHandler(void *pDest, uint16_t evt, void *pData)
{
	...
	case AFE_EVT_COMM_L1_SET:
		appSerialCanDavinciSendTextMessage("AFE_EVT_COMM_L1_SET");
		apiEventLogSaveLogData(EVENT_TYPE_AFE_COMM_L1_SET, 0);
		break;
	case AFE_EVT_COMM_L1_RELEASE:
		appSerialCanDavinciSendTextMessage("AFE_EVT_COMM_L1_RELEASE");
		apiEventLogSaveLogData(EVENT_TYPE_AFE_COMM_L1_RELEASE, 0);
		break;
	case AFE_EVT_COMM_L2_SET:
		appSerialCanDavinciSendTextMessage("AFE_EVT_COMM_L2_SET");
		apiEventLogSaveLogData(EVENT_TYPE_AFE_COMM_L2_SET, 0);
		relayOff();
		break;
	case AFE_EVT_COMM_L2_RELEASE:
		appSerialCanDavinciSendTextMessage("AFE_EVT_COMM_L2_RELEASE");
		apiEventLogSaveLogData(EVENT_TYPE_AFE_COMM_L2_RELEASE, 0);
...
static void buttonEventHandler(void *pDest, uint16_t evt, void *pData)
{
	...
	case BUTTON_EVT_CLICK_KEY_0:
		appSerialCanDavinciSendTextMessage("BUTTON_EVT_CLICK_KEY_0");
		break;
	case BUTTON_EVT_LONG_PRESS_KEY_0:
		appSerialCanDavinciSendTextMessage("BUTTON_EVT_LONG_PRESS_KEY_0");
		break;
	case BUTTON_EVT_PRESS_1S_KEY_0:
		appSerialCanDavinciSendTextMessage("BUTTON_EVT_PRESS_1S_KEY_0");
		break;
	case BUTTON_EVT_PRESS_KEY_0:
		appSerialCanDavinciSendTextMessage("BUTTON_EVT_PRESS_KEY_0");
		break;
	case BUTTON_EVT_RELEASE_KEY_0:	
		appSerialCanDavinciSendTextMessage("BUTTON_EVT_RELEASE_KEY_0");
		break;
	}
}
...
static void appProjectSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
...
void EepromFunctionTest(void)
{
	...
	appSerialCanDavinciSendTextMessage("----Erase");
	HalEePromRead(&mHalEeProm);
	DumpBuffer(buffer, 32);

	if(HalEePromErase(&mHalEeProm) != 0)
	{
		appSerialCanDavinciSendTextMessage("Erase Error");
	}
	HalEePromRead(&mHalEeProm);
	DumpBuffer(buffer, 32);
  	appSerialCanDavinciSendTextMessage("----Write");
	for(i=0; i<100; i++)
		buffer[i] = i;	
	HalEePromWrite(&mHalEeProm);
	
  	appSerialCanDavinciSendTextMessage("----Read"); 
	HalEePromRead(&mHalEeProm);
	DumpBuffer(buffer, 32);
}
...
static void ocpReleaseSwTimer( void *dest, uint16_t evt, void *vDataPtr)
{
...
void appProjectOpen(void){
	...
	appSerialCanDavinciSendTextMessage("--------- Start Run -----------...9");
	len = apiSysParOpen();
	...
	if(apiRamLoadRtcMagicCode() != 0x5ACD)
	{
		...
		appSerialCanDavinciSendTextMessage("Rtc Invalid");
		RtcValid = 0;
	}
	else
	{
		appSerialCanDavinciSendTextMessage("Rtc valid");
		RtcValid = 1;
	}
