...
#line 19 "..\\..\\..\\HAL\\HalTimerSTM32L4xx.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 20 "..\\..\\..\\HAL\\HalTimerSTM32L4xx.c"
...
#line 21 "..\\..\\..\\HAL\\HalTimerSTM32L4xx.c"
...
#line 22 "..\\..\\..\\HAL\\HalTimerSTM32L4xx.c"
...
static tLibRegisterEvtHandler	TimerEvtHandler3;
...
int8_t HalTimerOpen(tHalTimer *pHalTimer, tLibRegisterEvtHandler evtHandler)
{
	volatile uint32_t uwPrescalerValue = 0;
	...
	if(pHalTimer->TimerNo == 3)
	{
      do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (1U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (1U)))); (void)tmpreg; } while(0);
  		...
  		TimHandle3.Instance = ((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL));
...
int8_t HalTimerClose(tHalTimer *pHalTimer)
{
	if(pHalTimer->TimerNo == 3)
	{
		TimerEvtHandler3 = 0;
