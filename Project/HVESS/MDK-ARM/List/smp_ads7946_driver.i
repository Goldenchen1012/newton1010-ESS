...
#line 19 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
#line 20 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
#line 21 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
...
#line 22 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
#line 23 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
...
static _Bool Flag_ADS7946_HW_Init_Done = 0;
uint8_t ADS7946_tx_data[256];
uint8_t ADS7946_rx_data[256];
...
#line 61 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
	...
	ADS7956_CH_SEL_handler.port = SMP_GPIOC;
	ADS7956_CH_SEL_handler.pin = PIN5;
	...
	if(smp_spi_master_init(&ADS7946_SPI_0, ADS7946_SPI_0_event_handler, 0) != ((0x0) - 0)){
		return ((0x0) - 1);
	}
	if(!Flag_ADS7946_HW_Init_Done){
		Flag_ADS7946_HW_Init_Done = 1;
	}
...
int8_t smp_ADS7946_deinit(void)
{
	...
	if(smp_spi_master_deinit(&ADS7946_SPI_0) != ((0x0) - 0)){
		return ((0x0) - 1);
	}
...
#line 134 "..\\..\\..\\Drivers\\SMP\\smp_ADS7946_Driver.c"
