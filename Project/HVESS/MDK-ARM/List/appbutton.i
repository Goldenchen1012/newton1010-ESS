...
static void buttonSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
	if(evt == LIB_SW_TIMER_EVT_SW_10MS_2)
	{
        ...
        case BUTTON_STATE_RELEASE:
            if(apiSignalFeedbackGetStatus(APP_SIGNAL_ID_BUTTON) == 0)
            {
                ...
                _LibRegisterTypeHandlerExe(( tLibRegister *)&buttonRegister, BUTTON_EVT_PRESS_KEY_0, ( void *)0);
            }
            break;
        case BUTTON_STATE_PRESSING:
            if(apiSignalFeedbackGetStatus(APP_SIGNAL_ID_BUTTON) == 0)
            {
                ...
                {
                    _LibRegisterTypeHandlerExe(( tLibRegister *)&buttonRegister, BUTTON_EVT_PRESS_1S_KEY_0, ( void *)0);
                }
                if(pressCountKey0 >= 3000)
                {
                    buttonStateKey0 = BUTTON_STATE_LONG_PRESSED;
                    _LibRegisterTypeHandlerExe(( tLibRegister *)&buttonRegister, BUTTON_EVT_LONG_PRESS_KEY_0, ( void *)0);
                }
            }
            else
            {
                buttonStateKey0 = BUTTON_STATE_RELEASE;
                _LibRegisterTypeHandlerExe(( tLibRegister *)&buttonRegister, BUTTON_EVT_RELEASE_KEY_0, ( void *)0);
                _LibRegisterTypeHandlerExe(( tLibRegister *)&buttonRegister, BUTTON_EVT_CLICK_KEY_0, ( void *)0);
            }
            break;
        case BUTTON_STATE_LONG_PRESSED:
            if(apiSignalFeedbackGetStatus(APP_SIGNAL_ID_BUTTON) == 1)
            {
                buttonStateKey0 = BUTTON_STATE_RELEASE;
                _LibRegisterTypeHandlerExe(( tLibRegister *)&buttonRegister, BUTTON_EVT_RELEASE_KEY_0, ( void *)0);
            }
...
void appButtonOpen(tLibRegisterEvtHandler EventHandler)
{
	_LibRegisterAdd(( tLibRegister *)&buttonRegister, EventHandler, ( void *)0);	
