#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 1 "..\\..\\..\\HAL\\HalRtc.h"
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 30 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.h"
...
#line 31 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 32 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
#line 1 "..\\..\\..\\APP\\AppBms.h"
...
#line 33 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 34 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 35 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
#line 36 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCmd.c"
...
static void davinciCanAdc(smp_can_package_t *pCanPkg)
{
	...
	if((pCanPkg->id & 0x3ff) == 0x00)
	{
		
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x03<<10)|(uint32_t)0x00);


		AdcValue.sl = halAfeGetCurrentAdcValue(0);
	}
	else if((pCanPkg->id & 0x3ff) == 0x01)
	{
		
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x03<<10)|(uint32_t)0x01);


		AdcValue.sl = halAfeGetCurrentAdcValue(1);
	}
	else if((pCanPkg->id & 0x3ff) == 0x10)
	{
		
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x03<<10)|(uint32_t)0x10);


		AdcValue.sl = halAfeGetVBatAdcValue(0);
	}
	else if((pCanPkg->id & 0x3ff) == 0x11)
	{
		
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x03<<10)|(uint32_t)0x11);
...
static void davinciCanRtc(smp_can_package_t *pCanPkg)
{
	...
	if((pCanPkg->id & 0x3ff) == 0x01)
	{
		
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x02<<10)|(uint32_t)0x01);
	...
	else if((pCanPkg->id & 0x3ff) == 0x00)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x02<<10)|(uint32_t)0x00);
...
static void davinciCanRelayOn(smp_can_package_t *pCanPkg)
{
	...
	scuid = (pCanPkg->id & 0x3ff);
	if(memcmp(&pCanPkg->dat[0], "RelayOn", 7) == 0) 
	{
		apiRelayControlSetMasterTurnOnFlag();
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)scuid<<18)|((uint32_t)0x04<<10)|(uint32_t)appProjectGetScuId());
...
static void davinciCanChecksumn(smp_can_package_t *pCanPkg)
{
	...
	subindex = (pCanPkg->id & 0x3ff);

	CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x06<<10)|(uint32_t)subindex);
...
static void davinciCanPfFlag(smp_can_package_t *pCanPkg)
{
	...
	if(subindex == 0x00)
	{
		...
		appSerialCanDavinciSendTextMessage("Clear All PF Flag");
	}
	else if(subindex == 0x01)
	{
		apiSysParOvpPfClean();
		apiProtectOvpPfClean();
		appSerialCanDavinciSendTextMessage("Clear OVP PF Flag");	
	}
	else if(subindex == 0x02)
	{
		apiSysParUvpPfClean();
		apiProtectUvpPfClean();
		appSerialCanDavinciSendTextMessage("Clear UVP PF Flag");
	}
	appSerialCanDavinciPutPkgToCanFifo(&CanPkg);
}
...
static void davinciCanCleanData(smp_can_package_t *pCanPkg)
{
	...
	CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x08<<10)|(uint32_t)subindex);


	if(subindex == 0x00)
	{
		appSerialCanDavinciSendTextMessage("Clear All data");
		
	}	
	else if(subindex == 0x01)
	{
		appSerialCanDavinciSendTextMessage("Clear cycle count");	
		appGaugeCleanCycleCount();
	}
	else if(subindex == 0x02)
	{
		appSerialCanDavinciSendTextMessage("Clear fault log1");
	}
	else if(subindex == 0x03)
	{
		appSerialCanDavinciSendTextMessage("Clear fault log2");
	}
}
...
static void faultLog1DataCallBack(uint8_t num, uint8_t *pBuf)
{
	...
	for(n=0; n<num; n++)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x09<<10)|(uint32_t)0x20+n);
...
static void davinciCanFaultLog(smp_can_package_t *pCanPkg)
{
	...
	CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x09<<10)|(uint32_t)subindex);
	...
	if(subindex == 0x01)
	{
		...
		appSerialCanDavinciSendTextMessage("Read Fault Log1 number");
		appSerialCanDavinciPutPkgToCanFifo(&CanPkg);
	}	
	else if(subindex == 0x02)
	{
		appSerialCanDavinciSendTextMessage("Read Fault Log2 number");
	}
	else if(subindex == 0x10)
	{
		...
		appSerialCanDavinciSendTextMessage("Read Fault Log1 data");

		apiEventLogReadLogData(Lbyte.l, ReadNum.l, faultLog1DataCallBack);

	}
	else if(subindex == 0x11)
	{
		appSerialCanDavinciSendTextMessage("Read Fault Log2 data");
	}
}
static void davinciCanSoc(smp_can_package_t *pCanPkg)
{
	...
	CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x0A<<10)|(uint32_t)subindex);			
	...
	{
		CanPkg.dlc = 0;
		appSerialCanDavinciSendTextMessage("Update Soc");
		appGaugeUpdateSoc0();
	}	
	else if(subindex == 0x02)
	{
		appSerialCanDavinciSendTextMessage("Set Soc");
		Soc0.i = ((((WORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
...
const tAppSerialSmpCanDecode mDavinciCanCmdRxTab[] = {
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x00<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanParameterRdWrite},




								
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x01<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanParameterRdWrite},




								
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x02<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanRtc},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x03<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanAdc},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x04<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanRelayOn},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x06<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanChecksumn},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x07<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanPfFlag},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x08<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanCleanData},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x09<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanFaultLog},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0x0A<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)davinciCanSoc},
