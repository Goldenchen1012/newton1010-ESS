...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 30 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 31 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
#line 32 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 1 "..\\..\\..\\HAL\\HalBsp.h"
...
#line 33 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
#line 34 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.c"
...
static void DavinciCanDebugModeChange(smp_can_package_t *pCanPkg)
{
	...
	else if(subindex == 0x02)
	{
		if(memcmp(pCanPkg->dat, "EnterEng", 8) == 0)
		{
			...
			appSerialCanDavinciSendTextMessage("Enter Eng. Mode");
		}
		else if(memcmp(pCanPkg->dat, "ExitEngM", 8) == 0)
		{
			appProjectDisableEngMode();
			appSerialCanDavinciSendTextMessage("Exit Eng. Mode");
		}
	}
}
...
static void DavinciCanDebugCurrentAdc(smp_can_package_t *pCanPkg)
{
	...
	adc = (int32_t)(((((WORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))));

	halAfeSetCurrentAdcValue((pCanPkg->id & 0x3ff), adc);

	sprintf(str,"adc:%d I = %d", adc, appCurrDebug((pCanPkg->id & 0x3ff), adc));
...
static void DavinciCanDebugVbatAdc(smp_can_package_t *pCanPkg)
{
	...
	halAfeSetVBatAdcValue((pCanPkg->id & 0x3ff), adc);

	sprintf(str,"adc:%d V = %d", adc, appVbatDebug((pCanPkg->id & 0x3ff), adc));
	appSerialCanDavinciSendTextMessage(str);
}
...
static void DavinciCanDebugCellVSimu(smp_can_package_t *pCanPkg)
{
	...
	for(i=0; i<4 ; i++)
	{
		voltage = ((((WORD)(*(BYTE *)(&pCanPkg->dat[i*2]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[i*2]+0)))));
...
static void DavinciCanDebugCurrentSimu(smp_can_package_t *pCanPkg)
{
	...
	if(subindex == 0)
	{
		HalAfeSetCurrentValue(0, (int32_t)((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))));


	}
	else if(subindex == 1)
	{
		HalAfeSetCurrentValue(1, (int32_t)((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))));
	}
}
...
static void DavinciCanDebugVBatSimu(smp_can_package_t *pCanPkg)
{
	...
	if(subindex == 0)
	{
		halAfeSetVBatVoltage(0, (uint32_t)((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))));
	}
	else if(subindex == 1)
	{
		halAfeSetVBatVoltage(1, (uint32_t)((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))));
	}
}
static void DavinciCanDebugRelayControl(smp_can_package_t *pCanPkg)
{
	...
	case 0x01:
		...
		{
			HalBspRelayPsCtrl(1);
			appSerialCanDavinciSendTextMessage("Ps Relay On");
		}
		else
		{
			HalBspRelayPsCtrl(0);
			appSerialCanDavinciSendTextMessage("Ps Relay Off");
		}
		break;
	case 0x02:
		if(pCanPkg->dat[0])
		{
			...
			appSerialCanDavinciSendTextMessage("P Main Relay On");
		}
		else
		{
			halBspPostiveRelayOff();
			appSerialCanDavinciSendTextMessage("P Main Relay Off");
		}
		break;
	case 0x03:
		if(pCanPkg->dat[0])
		{
			...
			appSerialCanDavinciSendTextMessage("N Main Relay On");
		}
		else
		{
			halBspNegtiveRelayOff();
			appSerialCanDavinciSendTextMessage("N Main Relay Off");
		}
		break;
	case 0x04:
		if(pCanPkg->dat[0])
		{
			...
			appSerialCanDavinciSendTextMessage("Pre Relay On");
		}
		else
		{
			halBspPreDischargeRelayOff();
			appSerialCanDavinciSendTextMessage("Pre Relay Off");
		}
		break;
	case 0x05:
		if(pCanPkg->dat[0])
		{
			halBspFanRelayOn();
			appSerialCanDavinciSendTextMessage("FAN Relay On");
		}
		else
		{
			halBspFanRelayOff();
			appSerialCanDavinciSendTextMessage("FAN Relay Off");
		}
		break;
	}
}
...
const tAppSerialSmpCanDecode mDavinciDebugCanDecodeTab[] = {
	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x00<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugModeChange},





	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x01<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugCurrentAdc},





	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x02<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugVbatAdc},
	...
	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x05<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugCellVSimu},





	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x06<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugNtcVSimu},




	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x07<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugNtcTSimu},
	...
	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x08<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugGpio},




								
	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x09<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugCurrentSimu},





	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x0A<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugVBatSimu},





	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0x0B<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)DavinciCanDebugRelayControl},
