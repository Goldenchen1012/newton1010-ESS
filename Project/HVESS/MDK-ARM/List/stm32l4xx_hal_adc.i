...
#line 304 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef *hadc)
{
  ...
  {
#line 472 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
     ...
     )
  {
    ...
    {
      if ((LL_ADC_IsEnabled(((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL))) | LL_ADC_IsEnabled(((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040100UL))) | LL_ADC_IsEnabled(((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040200UL))) ) == 0UL)
      {
...
#line 644 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
      }
      else
      {
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef *hadc)
{
  ...
  if ((LL_ADC_IsEnabled(((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL))) | LL_ADC_IsEnabled(((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040100UL))) | LL_ADC_IsEnabled(((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040200UL))) ) == 0UL)
  {
    ...
    (((((ADC_Common_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040300UL)))->CCR) &= ~((0x3UL << (16U)) | (0xFUL << (18U)) | (0x1UL << (24U)) | (0x1UL << (23U)) | (0x1UL << (22U)) | (0x3UL << (14U)) | (0x1UL << (13U)) | (0xFUL << (8U)) | (0x1FUL << (0U))));
...
#line 878 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
...
#line 1176 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
...
HAL_StatusTypeDef HAL_ADC_Start(ADC_HandleTypeDef *hadc)
{
  ...
  uint32_t tmp_multimode_config = LL_ADC_GetMultimode((((ADC_Common_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040300UL))));
  ...
  if (LL_ADC_REG_IsConversionOngoing(hadc->Instance) == 0UL)
  {
    ...
    if (tmp_hal_status == HAL_OK)
    {
      ...
      if ((((((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040100UL))))? (((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL))) : (hadc->Instance) ) == hadc->Instance)
      ...
      else
      {
        ...
        tmpADC_Master = ((((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040100UL))))? (((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL))) : (hadc->Instance) );
...
#line 1322 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
    }
    else
    {
...
HAL_StatusTypeDef HAL_ADC_PollForConversion(ADC_HandleTypeDef *hadc, uint32_t Timeout)
{
  ...
  else  
  {
    ...
    else
    {
      ...
      if (LL_ADC_GetMultiDMATransfer((((ADC_Common_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040300UL)))) != (0x00000000UL))
      {
        ((hadc->State) |= ((0x00000020UL)));
        return HAL_ERROR;
      }
...
#line 1470 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
  }
...
#line 1916 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_adc.c"
    }
    else
    {
...
HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef *hadc, ADC_ChannelConfTypeDef *sConfig)
{
  ...
  if (LL_ADC_REG_IsConversionOngoing(hadc->Instance) == 0UL)
  {
    ...
    if ((((sConfig->Channel) & ((0x80000000UL) | (0x00080000UL))) != 0UL))
    {
      ...
      {
        if (((((hadc)->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL))) || (((hadc)->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040200UL)))))
        {
