...
#line 19 "..\\..\\..\\Drivers\\SMP\\smp_max7219.c"
...
#line 20 "..\\..\\..\\Drivers\\SMP\\smp_max7219.c"
...
#line 21 "..\\..\\..\\Drivers\\SMP\\smp_max7219.c"
...
#line 22 "..\\..\\..\\Drivers\\SMP\\smp_max7219.c"
...
#line 23 "..\\..\\..\\Drivers\\SMP\\smp_max7219.c"
...
0x00,0x00,0x00,0x30,0x10,0x20,0x00,0x00, 
...
0x44,0x44,0x44,0x44,0x44,0x54,0x38,0x00, 
...
0x18,0x24,0x20,0x20,0x70,0x20,0x20,0x00, 
...
0x00,0x44,0x44,0x44,0x54,0x28,0x00,0x00, 
0x00,0x44,0x28,0x10,0x28,0x44,0x00,0x00, 
0x00,0x44,0x44,0x3C,0x04,0x04,0x38,0x00, 
...
void max7219_SendByte(uint8_t *dataout, uint8_t len)
{
  ...
  for(j=0; j<len ; j++){
      for (i=8; i>0; i--) {
        ...
        (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))->ODR &= ~((uint16_t)0x0800));                                      
				max7219_small_delay(1);
        if (dataout[j] & mask)                              
          (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))->ODR |= ((uint16_t)0x2000));                                   
        else                                                  
          (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))->ODR &= ~((uint16_t)0x2000));                                   
        (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))->ODR |= ((uint16_t)0x0800));                                      
				max7219_small_delay(1);
...
void maxSendSequence(uint8_t *pSequence, uint8_t len)
{
   ...
   (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL))->ODR &= ~((uint16_t)0x1000));
	 max7219_small_delay(1);
