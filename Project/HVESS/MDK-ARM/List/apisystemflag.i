...
#line 45 "..\\..\\..\\API\\ApiSystemFlag.c"
#line 46 "..\\..\\..\\API\\ApiSystemFlag.c"
#line 47 "..\\..\\..\\API\\ApiSystemFlag.c"
#line 1 "..\\..\\..\\APP\\AppBms.h"
...
static void checkOtherFlag(void)
{
	...
	if(appBmsIsScudIdReady())
		SystemFlag1Temp |= (1U << 30);

	if(appProjectIsSystemReadyFlag())
		SystemFlag1Temp |= (1U << 31);
...
static void checkCOCP_DOCP_Flag(void)
{
	...
	if( (flag & (0x03 << 0)) >= (0x02 << 0))
	{
		SystemFlag1Temp |= (1 << 22);
	}

	if( (flag & (0x03 << 2)) >= (0x02 << 2))
	{
		SystemFlag1Temp |= (1 << 23);
	}

	if( (flag & (0x03 << 4)) >= (0x02 << 4))
	{
		SystemFlag1Temp |= (1 << 24);
	}
			
	flag = apiProtectDocpGetFlag();
	if( (flag & (0x03 << 0)) >= (0x02 << 0))
	{
		SystemFlag1Temp |= (1 << 26);
	}

	if( (flag & (0x03 << 2)) >= (0x02 << 2))
	{
		SystemFlag1Temp |= (1 << 27);
	}

	if( (flag & (0x03 << 4)) >= (0x02 << 4))
	{
		SystemFlag1Temp |= (1 << 28);
	}
	systemFlagNextFunction();
}
...
static void checkDUTP_L3(void)
{
	...
	for(; SystemFlagSubIndex < apiSysParGetNtcNumber(); SystemFlagSubIndex++)
	{
		flag = apiProtectDutpGetFlag(SystemFlagSubIndex);
		if( (flag & (0x03 << 4)) >= (0x02 << 4))
		{
			SystemFlag1Temp |= (1 << 19);
			systemFlagNextFunction();
			return;
		}
	}
	if(SystemFlagSubIndex >= apiSysParGetNtcNumber())
	{
		systemFlagNextFunction();
	}
}
...
static void checkUVP_L3(void)
{
	...
	for(; SystemFlagSubIndex < apiSysParGetCellNumber(); SystemFlagSubIndex++)
	{
	...
	if(SystemFlagSubIndex >= apiSysParGetCellNumber())
	{
		systemFlagNextFunction();
	}
}
...
static void systemFlagSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
