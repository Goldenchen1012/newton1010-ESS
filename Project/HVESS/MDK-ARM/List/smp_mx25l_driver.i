...
#line 18 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
...
#line 19 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
#line 20 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
#line 21 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
#line 22 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
...
#line 23 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
...
#line 69 "..\\..\\..\\Drivers\\SMP\\smp_MX25L_Driver.c"
...
uint8_t MX25L_tx_data[256];
uint8_t MX25L_rx_data[2000];

smp_fifo_flash_t flash_read_fifo = {0};

smp_flash_package flash_read_buffer[256];
smp_flash_t mDavinci_flash = { . buffers . rx_buf = flash_read_buffer, . buffers . rx_buf_size = 256 };
...
int8_t smp_mx25l_flash_init(void)
{
	...
	MX25L_write_protection_handler.port = SMP_GPIOB;
	MX25L_write_protection_handler.pin = PIN4;
	...
	if(smp_spi_master_init(&MX25L_SPI_1, MX25L_SPI_1_event_handler, 0) != ((0x0) - 0)){
		return ((0x0) - 1);
	}
...
int8_t smp_mx25l_flash_fast_read_data_bytes_page(uint16_t page , uint8_t *buffer , uint16_t read_byte_num , smp_flash_event_t smp_flash_event_handle)
{
	...
	smp_flash_package	FlashPkg;
	FlashPkg.command = 0x0b;
  FlashPkg.addr[0] = (uint8_t)((page << 8) >> 16) ;
	FlashPkg.addr[1] = (uint8_t)((page << 8) >> 8) ;
	FlashPkg.addr[2] = (uint8_t)(page << 8);
...
int8_t smp_mx25l_flash_sector_erase_sectornum(uint16_t sector_num , smp_flash_event_t smp_flash_event_handle)
{
	...
	smp_flash_package	FlashPkg;
	FlashPkg.command = 0x20;
	FlashPkg.addr[0] = (uint8_t)((sector_num << 12) >> 16) ;
	FlashPkg.addr[1] = (uint8_t)((sector_num << 12) >> 8) ;
	FlashPkg.addr[2] = (uint8_t)(sector_num << 12);
...
void MX25L_SPI_1_event_handler(smp_spi_evt_type p_evt)
{
	...
	switch(p_evt){
		case SMP_SPI_EVENT_DONE:	
			...
			}else if(FlashPkg.command == (0x20|0xd8|0xc7)){
