...
void HAL_RTC_MspInit(RTC_HandleTypeDef *hrtc)
{
  ...
  PeriphClkInitStruct.PeriphClockSelection = 0x00020000U;
  PeriphClkInitStruct.RTCClockSelection = (0x1UL << (8U));
    
  if(HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
  { 
    Error_Handler();
  }
#line 105 "..\\..\\..\\HAL\\HalRtcSTM32L4xx.c"
...
void HalRtcGetDateTime(tHalRtcDateTime *pDateTime)
{
	RTC_DateTypeDef sdatestructureget;
  	...
  	HAL_RTC_GetTime(&RtcHandle, &stimestructureget, 0x00000000u);
  	 
  	HAL_RTC_GetDate(&RtcHandle, &sdatestructureget, 0x00000000u);
...
uint32_t HalRtcGetSmpUnixTime(void)
{
    ...
    yearoff = (mRtcDateTime.Year % 400);                
    baseday = (mRtcDateTime.Year / 400) * 146097L;
    if (yearoff > 0)
