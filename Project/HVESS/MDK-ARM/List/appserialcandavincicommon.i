...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
#line 1 "..\\..\\..\\APP\\AppBms.h"
...
#line 30 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.c"
...
static void DavinciCommonRequestScuId(smp_can_package_t *pCanPkg)
{
	...
	if(appBmsIsInAssignIdMode())
	{
		if(memcmp(&pCanPkg->dat, "GetScuID", 8) == 0)
		{
			...
			CanPkg.id = (((uint32_t)0x05<<25)|((uint32_t)scuid<<18)|((uint32_t)0x01<<10)|(uint32_t)scuid + 1);
 ...
 static void DavinciCommonSetScuId(smp_can_package_t *pCanPkg)
{
	...
	if(appBmsIsInScuIdRequestMode())
	{
		...
		{
			CanPkg.id = (((uint32_t)0x04<<25)|((uint32_t)scuid<<18)|((uint32_t)0x02<<10)|(uint32_t)scuid - 1);
...
static void DavinciCommonStopScuIdAssign(smp_can_package_t *pCanPkg)
{
	...
	
	{
		...
		{
			source_id = ((pCanPkg->id >> 18) & 0x7f);
			scuid = appBmsGetScuId();
			if(source_id == (scuid + 1))
			{
				CanPkg.id = (((uint32_t)0x05<<25)|((uint32_t)source_id<<18)|((uint32_t)0x02<<10)|(uint32_t)scuid);
...
static void DavinciCommonResetScuId(smp_can_package_t *pCanPkg)
{
	...
	{
		appBmsResetScuId();
		appSerialCanDavinciSendTextMessage("RESET SCU ID");
	}
}
...
const tAppSerialSmpCanDecode mDavinciCommonCanDecodeTab[] = {
	{(((uint32_t)0x04<<25)|((uint32_t)0<<18)|((uint32_t)0x01<<10)|(uint32_t)0), (0x0fu << 25) | (0xffu << 10), (tAppSerialPacketExe)DavinciCommonRequestScuId},





	{(((uint32_t)0x05<<25)|((uint32_t)0<<18)|((uint32_t)0x01<<10)|(uint32_t)0), (0x0fu << 25) | (0xffu << 10), (tAppSerialPacketExe)DavinciCommonSetScuId},
	...
	{(((uint32_t)0x04<<25)|((uint32_t)0<<18)|((uint32_t)0x02<<10)|(uint32_t)0), (0x0fu << 25) | (0xffu << 10), (tAppSerialPacketExe)DavinciCommonStopScuIdAssign},




	{(((uint32_t)0x05<<25)|((uint32_t)0<<18)|((uint32_t)0x02<<10)|(uint32_t)0), (0x0fu << 25) | (0xffu << 10), (tAppSerialPacketExe)DavinciCommonStopScuIdRequest},





	{(((uint32_t)0x04<<25)|((uint32_t)0<<18)|((uint32_t)0x00<<10)|(uint32_t)0), (0x0fu << 25) | (0xffu << 10), (tAppSerialPacketExe)DavinciCommonResetScuId},
