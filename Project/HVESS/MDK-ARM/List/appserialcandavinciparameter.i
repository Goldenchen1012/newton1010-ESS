#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 1 "..\\..\\..\\Drivers\\SMP\\smp_can.h"
...
#line 17 "..\\..\\..\\Drivers\\SMP\\smp_can.h"
#line 18 "..\\..\\..\\Drivers\\SMP\\smp_can.h"
#line 1 "..\\..\\..\\Lib\\SMP\\smp_can_fifo.h"
...
#line 17 "..\\..\\..\\Lib\\SMP\\smp_can_fifo.h"
...
typedef struct{
	smp_can_package_t		*rx_buf;                  
	uint32_t				    rx_buf_size;			        
	smp_can_package_t		*tx_buf;                  
	uint32_t				    tx_buf_size;              
}can_buffer_t;

typedef struct{
	can_module_number	  num;                      
	uint32_t			      baud_rate;                
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.h"
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.h"
#line 1 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 21 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 64 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"





#line 80 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 104 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 127 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 148 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 163 "..\\..\\..\\AppCommunication\\SmpCanBusProtocol.h"
...
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.h"
#line 1 "..\\..\\..\\AppCommunication\\SmpParameterID.h"
...
#line 32 "..\\..\\..\\AppCommunication\\SmpParameterID.h"

#line 58 "..\\..\\..\\AppCommunication\\SmpParameterID.h"

#line 74 "..\\..\\..\\AppCommunication\\SmpParameterID.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.h"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.h"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
#line 30 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
#line 31 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciParameter.c"
...
static uint8_t	StringMessageBuffer[100 + 2];
...
static void magicCodeIdleSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
...
static void DavinciParameterMagicCode(smp_can_package_t *pCanPkg){
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x00);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x00);
...
static void DavinciCanParameterHwVersion(smp_can_package_t *pCanPkg){
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x01);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x01);


		CanPkg.dlc = 0;

		version.l =  ((((WORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
...
static void DavinciCanParameterFwVersion(smp_can_package_t *pCanPkg){
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x02);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x02);
...
static void DavinciCanParameterFwBuildDateTime(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x03);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x03);
...
static void DavinciCanParameterZeroCurrent(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x21);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x21);
...
static void DavinciCanParameterPreDischargeTime(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x22);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x22);
...
static void DavinciCanParameterRelayOnDiffVoltage(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x23);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x23);
...
static void DavinciCanParameterDesignedCapacity(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x24);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x24);


		CanPkg.dlc = 0;
		Lbyte.l = ((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
...
static void DavinciCanParameterFullChargeCondition(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x28);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x28);																		


		CanPkg.dlc = 0;
		ProtectPar.SetValue.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
		ProtectPar.STime.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[2]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[2]+0)))));
...
static void DavinciCanParameterFlatVoltage(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x29);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x29);																		
...
static void DavinciCanParameterTerminateVoltage(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x2A);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x2A);																		


		CanPkg.dlc = 0;
		voltage.i = ((((WORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[0]+0)))));
...
static void DavinciCanParameterAfeCommunication(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x32);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x32);																		
...
static void DavinciCanParameterInsulationResistance(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x38);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x38);																		
...
static void DavinciCanParameterQmax(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x2B);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x2B);																		
...
static void DavinciCanParameterRM(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x2D);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x2D);																		
...
static void DavinciCanParameterOcvTable(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0xA1);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0xA1);
		...
		OcvTable.Value = ((((WORD)(*(BYTE *)(&pCanPkg->dat[3]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[3]+0)))));
...
static void DavinciCanParameterRaTable(smp_can_package_t *pCanPkg){
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0xB1);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0xB1);
...
static void DavinciCanParameterOvp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x60);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x60);


		CanPkg.dlc = 0;
		ProtectPar.SetValue.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[1]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[1]+0)))));
		ProtectPar.STime.l = pCanPkg->dat[3];
		ProtectPar.RelValue.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[4]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[4]+0)))));
...
static void DavinciCanParameterUvp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x61);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x61);
...
static void DavinciCanParameterCotp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x62);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x62);
...
static void DavinciCanParameterCutp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x63);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x63);
...
static void DavinciCanParameterDotp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x64);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x64);
...
static void DavinciCanParameterDutp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x65);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x65);
...
static void DavinciCanParameterDtp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x66);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x66);
...
static void DavinciCanParameterCocp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x68);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x68);
...
static void DavinciCanParameterDocp(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x67);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x67);
...
static void DavinciCanParameterPF(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x6B);				
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x6B);
...
static void DavinciParameterBmuNumber(smp_can_package_t *pCanPkg){
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x27);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x27);
...
static void DavinciParameterCellNtcFlag(smp_can_package_t *pCanPkg){
	...
	{
		;
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x33);
	...
	else if(isParWritable())
	{
		...
		Lbyte.l = ((((DWORD)(*(BYTE *)(&pCanPkg->dat[1]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[1]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[1]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[1]+0)))));
		apiSysParSetCellFlag(pCanPkg->dat[0], Lbyte.l);
		
		Lbyte.l = ((((DWORD)(*(BYTE *)(&pCanPkg->dat[5]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[5]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[5]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[5]+0)))));
		Lbyte.b[3] = 0;
		apiSysParSetNtcFlag(pCanPkg->dat[0], Lbyte.l);
		
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x33);
...
static void DavinciCanParameterBalanceDuty(smp_can_package_t *pCanPkg)
{
	...
	{
		;
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x80);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x80);
...
static void DavinciCanParameterBalanceChg(smp_can_package_t *pCanPkg)
{
	...
	{
		;
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x81);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x81);
		...
		ProtectPar.STime.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[2]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[2]+0)))));
		ProtectPar.RelValue.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[4]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[4]+0)))));
		ProtectPar.RTime.l = ((((WORD)(*(BYTE *)(&pCanPkg->dat[6]+1)))<<8) + (((WORD)(*(BYTE *)(&pCanPkg->dat[6]+0)))));
...
static void DavinciCanParameterBalanceDhg(smp_can_package_t *pCanPkg)
{
	...
	{
		;
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x82);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x82);
...
static void DavinciCanParameterBalanceRlx(smp_can_package_t *pCanPkg)
{
	...
	{
		;
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x83);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x83);
...
static void DavinciCanParameterNoteMessage(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		...
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x0A);
	...
	else if(isParWritable())
	{
		...
		if(pCanPkg->dat[1] >= pCanPkg->dat[0])
		{
			...
			CanPkg.dat[0] = 1;
		CanPkg.dlc = 1;
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x0A);
...
static void DavinciCanParameterCurrentCalibration(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x92);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x92);
...
static void DavinciCanParameterVBatCalibration(smp_can_package_t *pCanPkg)
{
	...
	if(((pCanPkg->id >> 10) & 0xff) == 0x01)
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x01<<10)|(uint32_t)0x91);
	...
	{
		CanPkg.id = (((uint32_t)0x03<<25)|((uint32_t)appProjectGetScuId()<<18)|((uint32_t)0x00<<10)|(uint32_t)0x91);
...
const tAppSerialSmpCanDecode mDavinciParameterCanDecodeTab[] = {
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x00), (0x3ff), (tAppSerialPacketExe)DavinciParameterMagicCode},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x01), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterHwVersion},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x02), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterFwVersion},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x03), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterFwBuildDateTime},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x21), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterZeroCurrent},




                    			
 	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x22), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterPreDischargeTime},




                   			
 	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x23), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterRelayOnDiffVoltage},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x24), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterDesignedCapacity},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x28), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterFullChargeCondition},




                    			
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x29), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterFlatVoltage},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x2A), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterTerminateVoltage},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x32), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterAfeCommunication},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x38), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterInsulationResistance},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x2B), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterQmax},




	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x2D), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterRM},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x0A), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterNoteMessage},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x27), (0x3ff), (tAppSerialPacketExe)DavinciParameterBmuNumber},




	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x33), (0x3ff), (tAppSerialPacketExe)DavinciParameterCellNtcFlag},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0xA1), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterOcvTable},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0xB1), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterRaTable},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x60), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterOvp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x61), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterUvp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x62), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterCotp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x63), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterCutp},




	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x64), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterDotp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x65), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterDutp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x66), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterDtp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x68), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterCocp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x67), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterDocp},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x6B), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterPF},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x6B), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterBalanceDuty},
	...
	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x80), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterBalanceDuty},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x81), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterBalanceChg},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x82), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterBalanceDhg},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x83), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterBalanceRlx},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x92), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterCurrentCalibration},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0x91), (0x3ff), (tAppSerialPacketExe)DavinciCanParameterVBatCalibration},
