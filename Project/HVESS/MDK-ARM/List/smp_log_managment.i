...
#line 18 "..\\..\\..\\APP\\smp_log_managment.c"
...
int8_t app_flash_log_managment_init(smp_log_event_t smp_log_event_handle){
	...
	memset(&log_reflash_package_buffer[0], 0xff, 256);
	
	g_fix_page_header_package.package_num = 0;
	g_fix_page_header_package.page_usage_size = 0;
	memset(&log_fix_package_buffer[0], 0xff, 256);
...
void app_flash_log_managment_clean_head(void){
	...
	g_sector_header_package.header[3] = 'S';
	g_sector_header_package.reflash_memory_head_page = ((((0 + 128 - 1) + 1) + 1 - 1) + 1) * 16;
	g_sector_header_package.reflash_memory_current_page = ((((0 + 128 - 1) + 1) + 1 - 1) + 1) * 16;	
	g_sector_header_package.reflash_total_log_cnt = 0x0;
	g_sector_header_package.fix_memory_current_page = ((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) * 16;
	g_sector_header_package.fix_total_log_cnt = 0x0;
	g_sector_header_cnt = 0;
	smp_mx25l_flash_sector_erase_sectornum(((0 + 128 - 1) + 1),app_clean_event_handler);
}

void app_flash_log_managment_clean_reflash_memory(void){
	int i ;
	for(i = ((((0 + 128 - 1) + 1) + 1 - 1) + 1) ; i<=(((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) ;i++){
...
void app_flash_log_managment_clean_fix_memory(void){
	int i ;
	for(i = ((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) ; i<=(((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) + 4 - 1) ;i++){
		smp_mx25l_flash_sector_erase_sectornum(i,app_clean_event_handler);
	}
	g_sector_header_package.fix_memory_current_page = ((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) * 16;
	g_sector_header_package.fix_total_log_cnt = 0x0;
...
void app_flash_sector_header_save(smp_sector_header_package * sector_header){
	if((g_sector_header_cnt ==0)||(g_sector_header_cnt >= 16)){
		smp_mx25l_flash_sector_erase_sectornum(((0 + 128 - 1) + 1),app_sector_header_event_handler);
		g_sector_header_cnt = 0;
	}
	smp_mx25l_flash_page_program(((0 + 128 - 1) + 1) * 16 + g_sector_header_cnt,(uint8_t*)sector_header,sizeof(smp_sector_header_package),app_sector_header_event_handler);
	g_sector_header_cnt++;
}
...
void app_flash_sector_header_load(smp_sector_header_package * sector_header){
	...
	g_sector_header_cnt = 0;
	smp_mx25l_flash_fast_read_data_bytes_page(((0 + 128 - 1) + 1) * 16,(uint8_t*)sector_header,sizeof(smp_sector_header_package),app_sector_header_event_handler);
}
...
void app_flash_page_data_push(smp_log_package log_package,smp_flash_type flash_type){
	switch(flash_type){
		case SMP_REFLASH_MEMORY:
			...
			if((g_reflash_page_header_package.page_usage_size + 8) > 256){
				
				app_flash_page_data_save(SMP_REFLASH_MEMORY);
				
				memcpy(&log_reflash_package_buffer[g_reflash_page_header_package.page_usage_size], &log_package, 8);
				g_reflash_page_header_package.page_usage_size += 8;
				g_reflash_page_header_package.package_num += 1;		
			}else if ((g_reflash_page_header_package.page_usage_size + 8) == 256){
		...
		case SMP_FIX_MEMORY:
			...
			if(g_sector_header_package.fix_memory_current_page % 16 == 0){
				if(g_sector_header_package.fix_memory_current_page >= (((((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) + 4 - 1) + 1) * 16)){
					log_evt_cb(SMP_LOG_EVENT_MEMORY_FULL);
					return;
				}			
			}
			if((g_fix_page_header_package.page_usage_size + 8) > 256){
				
				app_flash_page_data_save(SMP_FIX_MEMORY);
				
				memcpy(&log_fix_package_buffer[g_fix_page_header_package.page_usage_size], &log_package, 8);
				g_fix_page_header_package.page_usage_size += 8;
				g_fix_page_header_package.package_num += 1;		
			}else if ((g_fix_page_header_package.page_usage_size + 8) == 256){
...
void app_flash_page_data_save(smp_flash_type flash_type){
	switch(flash_type){
		case SMP_REFLASH_MEMORY:
			if(g_sector_header_package.reflash_memory_current_page % 16 == 0){
				if(g_sector_header_package.reflash_memory_current_page >= (((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) * 16)){
					g_sector_header_package.reflash_memory_current_page = ((((0 + 128 - 1) + 1) + 1 - 1) + 1) * 16;
					g_sector_header_package.reflash_memory_head_page = (((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 1) * 16;
					g_sector_header_package.reflash_total_log_cnt -= 256/8 * 16;
				}
				if(g_reflash_page_header_package.page_usage_size ==0){
					smp_mx25l_flash_sector_erase_sectornum(g_sector_header_package.reflash_memory_current_page / 16,app_log_event_handler);
					printf("sector erase %d\r\n",g_sector_header_package.reflash_memory_current_page / 16);
				}
			}
			if((g_sector_header_package.reflash_memory_current_page==g_sector_header_package.reflash_memory_head_page)&&(g_sector_header_package.reflash_memory_head_page !=((((0 + 128 - 1) + 1) + 1 - 1) + 1) * 16)){
				g_sector_header_package.reflash_memory_head_page += 16;
				g_sector_header_package.reflash_total_log_cnt -= 256/8 * 16;
				if(g_sector_header_package.reflash_memory_head_page >= (((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) * 16)){
					g_sector_header_package.reflash_memory_head_page = ((((0 + 128 - 1) + 1) + 1 - 1) + 1) * 16;
				}
			}
			smp_mx25l_flash_page_program(g_sector_header_package.reflash_memory_current_page,(uint8_t*)log_reflash_package_buffer,256,app_log_event_handler);
		...
		case SMP_FIX_MEMORY:
			if(g_sector_header_package.fix_memory_current_page % 16 == 0){
				...
				if(g_fix_page_header_package.page_usage_size ==0){
					smp_mx25l_flash_sector_erase_sectornum(g_sector_header_package.fix_memory_current_page / 16,app_log_event_handler);
					printf("sector erase %d\r\n",g_sector_header_package.fix_memory_current_page / 16);
				}
			}
			smp_mx25l_flash_page_program(g_sector_header_package.fix_memory_current_page,(uint8_t*)log_fix_package_buffer,256,app_log_event_handler);
...
void app_flash_page_data_load(uint8_t * RX_buffer , uint16_t log_start_position, uint16_t log_length,smp_flash_type flash_type){
	...
	data_load_type.log_length_byte = log_length* 8;
	...
	switch(flash_type){
		case SMP_REFLASH_MEMORY:
			...
			temp_addr =  (g_sector_header_package.reflash_memory_head_page << 8) + log_start_position * 8;
			if(temp_addr >= (((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1)  + 1) * 16) << 8){
					temp_addr -= (4 * 16) << 8;
			}
		...
		case SMP_FIX_MEMORY:
			...
			temp_addr =  ((((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) * 16) << 8) + log_start_position * 8;
			if(temp_addr >= (((((((((0 + 128 - 1) + 1) + 1 - 1) + 1) + 4 - 1) + 1) + 4 - 1)  + 1) * 16) << 8){
					log_evt_cb(SMP_LOG_EVENT_ERROR);
					return;
			}
			data_load_type.log_start_addr = temp_addr;
	...
	switch(p_evt){
		case SMP_FLASH_EVENT_READ_DONE:
			if((g_sector_header_p->header[0] == 'S')||(g_sector_header_p->header[1] == 'M')||(g_sector_header_p->header[2] == 'P')){
				...
				printf("init aa%d\r\n",g_sector_header_cnt);
				if(g_sector_header_cnt < 16){
					smp_mx25l_flash_fast_read_data_bytes_page(((0 + 128 - 1) + 1) * 16 + g_sector_header_cnt,(uint8_t*)g_sector_header_p,sizeof(smp_sector_header_package),app_sector_header_event_handler);
					printf("init bb%d\r\n",g_sector_header_cnt);
				}else{
				...
				g_reflash_page_header_package.package_num = 0;
				g_reflash_page_header_package.page_usage_size = (g_sector_header_package.reflash_total_log_cnt % (256/8)) * 8;
				g_fix_page_header_package.package_num = 0;
				g_fix_page_header_package.page_usage_size = (g_sector_header_package.fix_total_log_cnt % (256/8)) * 8;
