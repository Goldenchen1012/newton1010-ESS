...
#line 2 "..\\..\\..\\APP\\AppProjectTest.c"
#line 3 "..\\..\\..\\APP\\AppProjectTest.c"
#line 4 "..\\..\\..\\APP\\AppProjectTest.c"
...
static void DebugGPIOInit(void){
	...
	GPIO_InitStructure.Pin = ((uint16_t)0x0400) | ((uint16_t)0x8000);
...
static void ADDS7946_Test_API1_SwTimerHandler( void *dest, uint16_t evt, void *vDataPtr){
	if(evt == LIB_SW_TIMER_EVT_SW_10MS_0){	
		HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)), ((uint16_t)0x8000), GPIO_PIN_SET);		
		smp_ADS7946_get_data(channel_1,CS_0,ADDS7946_Test_API1_callBack);
		HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)), ((uint16_t)0x8000), GPIO_PIN_RESET);
	}

}
static void ADS7946_Test_API1_2_SwTimerHandler( void *dest, uint16_t evt, void *vDataPtr){
	static uint8_t Cnt_1S = 0;
	if(evt == LIB_SW_TIMER_EVT_SW_10MS_1){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)), ((uint16_t)0x0400), GPIO_PIN_SET);
		smp_ADS7946_get_data(channel_1,CS_1,ADDS7946_Test_API2_callBack);
		HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1000UL)), ((uint16_t)0x0400), GPIO_PIN_RESET);
	}
...
static void appProjectTestSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
