...
#line 22 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
#line 23 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
#line 24 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
#line 25 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
...
int8_t smp_can_init(smp_can_t *p_can, smp_can_event_t smp_can_event_handler)
{
	...
	if(p_can->num == __CAN0){
 		...
 		smp_can0_handle.Instance = ((CAN_TypeDef *) ((0x40000000UL) + 0x6400UL));
		...
		smp_can0_handle.Init.AutoRetransmission = DISABLE;
  		...
  		smp_can0_handle.Init.Mode = (0x00000000U);
  		smp_can0_handle.Init.SyncJumpWidth = (0x00000000U);
  		smp_can0_handle.Init.TimeSeg1 = ((uint32_t)((0x2UL << (16U)) | (0x1UL << (16U))));
  		smp_can0_handle.Init.TimeSeg2 = ((uint32_t)(0x4UL << (20U)));
  		...
  		sFilterConfig.FilterFIFOAssignment = (0x00000000U);
		...
		can_fifo_init(&can0_tx_fifo, p_can->buffers.tx_buf, p_can->buffers.tx_buf_size);
		  ...
		  smp_can1_handle.Instance = ((CAN_TypeDef *) ((0x40000000UL) + 0x6800UL));
  		...
  		smp_can1_handle.Init.Mode = (0x00000000U);
  		smp_can1_handle.Init.SyncJumpWidth = (0x00000000U);
  		smp_can1_handle.Init.TimeSeg1 = ((uint32_t)((0x2UL << (16U)) | (0x1UL << (16U))));
  		smp_can1_handle.Init.TimeSeg2 = ((uint32_t)(0x4UL << (20U)));
...
#line 213 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
	}else if(p_uart->num == __CAN1){
#line 221 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
	}		
	return ((0x0) - 0);
}
...
int8_t smp_can_put(smp_can_t *p_can, smp_can_package_t *pCanDat)
{
	...
	if(p_can->num == __CAN0){
#line 256 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
	}else if(p_can->num == __CAN1){		
        smp_can_fifo_push(&can1_tx_fifo, pCanDat);
		...
		if(1)
        {
        	...
        	if(HAL_CAN_GetTxMailboxesFreeLevel(&smp_can1_handle) != 0)
        	{
       			...
       			if(smp_can_fifo_pop(&can1_tx_fifo, &CanPkg) == ((0x0) - 0))
       			{
       				if(CanPkg.id & 0x80000000L)
       				{
						TxHeader.StdId = (CanPkg.id & 0x1FFFFFFFL);
						TxHeader.IDE = (0x00000000U);
					}
					else
					{
						TxHeader.ExtId = (CanPkg.id & 0x1FFFFFFFL);
						TxHeader.IDE = (0x00000004U);
					}
					if(CanPkg.id & 0x40000000L)
						TxHeader.RTR = (0x00000002U);
					else
						TxHeader.RTR = (0x00000000U);
...
#line 339 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
	}else if(hcan->Instance == ((CAN_TypeDef *) ((0x40000000UL) + 0x6800UL))){
...
#line 383 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
	}
}
...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
	...
	if(hcan->Instance == ((CAN_TypeDef *) ((0x40000000UL) + 0x6400UL))){
#line 427 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
		...
		if (HAL_CAN_GetRxMessage(hcan, (0x00000000U), &RxHeader, RxData) != HAL_OK)
		{
			 
			
			return;
		}
		if(RxHeader.IDE == (0x00000000U))
		{
			CanPkg.id = RxHeader.StdId;
			CanPkg.id |= 0x80000000L;
		}
		else
		{
			CanPkg.id = RxHeader.ExtId;
		}
		if(RxHeader.RTR == (0x00000002U))
		{
			CanPkg.id |= 0x40000000L;
		}
		...
		if(smp_can_fifo_push(&can1_rx_fifo, &CanPkg) == ((0x0) - 0))
		{
			if(can1_evt_cb)
...
#line 487 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
...
{	
	...
	else if(hcan->Instance == ((CAN_TypeDef *) ((0x40000000UL) + 0x6800UL)))
	{
		...
		do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (26U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (26U)))); (void)tmpreg; } while(0);
...
#line 582 "..\\..\\..\\Drivers\\SMP\\smp_can.c"
