...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"

#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.h"
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.h"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.h"
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciDebug.h"
...
#line 31 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciCommon.h"
...
#line 32 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
#line 33 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.h"
...
#line 34 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciFirmwareUpgrade.h"
...
#line 35 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\HAL\\HalRtc.h"
...
#line 36 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
#line 1 "..\\..\\..\\APP\\AppBms.h"
...
#line 37 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"
...
smp_can_package_t	Davinci_can_tx_buffer[400] = {0};
smp_can_package_t  Davinci_can_rx_buffer[400] = {0};


#line 56 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"


#line 66 "..\\..\\..\\AppCommunication\\AppSerialCanDavinci.c"


smp_can_t mDavinci_can0 = { . num = __CAN0, . baud_rate = 500000, . buffers . rx_buf = Davinci_can_rx_buffer, . buffers . rx_buf_size = 400, . buffers . tx_buf = Davinci_can_tx_buffer, . buffers . tx_buf_size = 400 };
smp_can_t mDavinci_can = { . num = __CAN1, . baud_rate = 500000, . buffers . rx_buf = Davinci_can_rx_buffer, . buffers . rx_buf_size = 400, . buffers . tx_buf = Davinci_can_tx_buffer, . buffers . tx_buf_size = 400 };
...
const tAppSerialSmpCanDecode mDavinciCanFunDecodeTab[] = {
	{(((uint32_t)0x00<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunBaseRxTx},




								
	{(((uint32_t)0x01<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunBaseRxTx},





	{(((uint32_t)0x02<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunCmdRx},





	{(((uint32_t)0x0A<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunDebugRx},





	{(((uint32_t)0x04<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunCommonRx},								




	{(((uint32_t)0x05<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunCommonRx},								





	{(((uint32_t)0x0C<<25)|((uint32_t)0<<18)|((uint32_t)0<<10)|(uint32_t)0), (0x0fu << 25), (tAppSerialPacketExe)DavinciCanFunFuRx},								
...
static void canDavinciPaserCanPackage(void)
{
	...
	for(i=0; i<6; i++)
	{
		if(smp_can_get(&mDavinci_can, &CanPkg) != ((0x0) - 0))
			break;
...
uint8_t appSerialCanDavinciIsCorrectScuId(smp_can_package_t *pCanPkg)
{
	if(((pCanPkg->id >> 18) & 0x7f) == appProjectGetScuId())
		return 1;
	else
		return 0;
}
...
void appSerialCanDavinciSendTextMessage(char *msg)
{
	...
	CanPkg.id = (((uint32_t)0x0B<<25)|((uint32_t)scuid<<18)|((uint32_t)0x04<<10)|(uint32_t)0);
...
void appSerialCanDavinciTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
...
void appSerialCanDavinciOpen(void)
{
	...
	if(smp_can_init(&mDavinci_can, DavinciCan_cb)==((0x0) - 0)){
		appSerialCanDavinciSendTextMessage("Can 1 ini success");
	 }else{
		appSerialCanDavinciSendTextMessage("Can 1 ini fail");
  	}  
