...
bsp_adc_init_io_config bsp_mcu_adc_config_table[16]={{((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , ((uint16_t)0x0001) },   
                                                                     {((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , ((uint16_t)0x0002) },
                                                                     {((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , ((uint16_t)0x0004) },
                                                                     {((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , ((uint16_t)0x0008) },
                                                                     {((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)) , ((uint16_t)0x0010) },
                                                                     {0 , 0 },
                                                                     {0 , 0 },
                                                                     {0 , 0 },
                                                                     {0 , 0 },
...
uint32_t  adc_sconfig_rank[16]={ (((0x00000000UL) | ( 6UL)))  ,
	                                               (((0x00000000UL) | (12UL)))  ,
                                                 (((0x00000000UL) | (18UL)))  ,
                                                 (((0x00000000UL) | (24UL)))  ,
                                                 (((0x00000100UL) | ( 0UL)))  ,
...
volatile uint16_t SMPADCVALUE1[16],SMPADCVALUE2[16],SMPADCVALUE3[16];
...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc){
	...
	if(hadc->Instance==((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL)))
	{
	    ...
	    PeriphClkInit.PLLSAI1.PLLSAI1P = 0x00000002U;
	    PeriphClkInit.PLLSAI1.PLLSAI1Q = 0x00000002U;
	    PeriphClkInit.PLLSAI1.PLLSAI1R = 0x00000008U;
	    ...
	    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (2U)))); (void)tmpreg; } while(0);
			...
			for(int i=0 ;i < 16; i++){
			    if((bsp_mcu_adc_config_table[i].gpio_port!=0) && (bsp_mcu_adc_config_table[i].gpio_pin!=0)){
			        HalBspSetGpio(bsp_mcu_adc_config_table[i].gpio_port, bsp_mcu_adc_config_table[i].gpio_pin, (0x0000000Bu), (0x00000000u), 0);
	    ...
	    smp_dma_adc1.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0008UL));
	    smp_dma_adc1.Init.Request = 0U;
	    smp_dma_adc1.Init.Direction = 0x00000000U;
	    smp_dma_adc1.Init.PeriphInc = 0x00000000U;
	    smp_dma_adc1.Init.MemInc = (0x1UL << (7U));
	    smp_dma_adc1.Init.PeriphDataAlignment = (0x1UL << (8U));
	    smp_dma_adc1.Init.MemDataAlignment = (0x1UL << (10U));
	    smp_dma_adc1.Init.Mode = (0x1UL << (5U));
 	    smp_dma_adc1.Init.Priority = 0x00000000U;
	    if (HAL_DMA_Init(&smp_dma_adc1) != HAL_OK)
	    {
	        Error_Handler();
	    }

	    do{ (hadc)->DMA_Handle = &(smp_dma_adc1); (smp_dma_adc1). Parent = (hadc); } while(0);
	...
	switch(num){
		case adc1:
			   ...
			   for(int i=0 ;i < 16; i++){
				...
				smp_adc_1.Instance = ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL));
				smp_adc_1.Init.ClockPrescaler = (((0x8UL << (18U)) | (0x2UL << (18U)) | (0x1UL << (18U))));
				smp_adc_1.Init.Resolution = ((0x00000000UL));
				smp_adc_1.Init.DataAlign = ((0x00000000UL));
				smp_adc_1.Init.ScanConvMode = (0x00000001UL);
				smp_adc_1.Init.EOCSelection = ((0x1UL << (3U)));
				...
				smp_adc_1.Init.ExternalTrigConv = ((0x00000000UL));
				smp_adc_1.Init.ExternalTrigConvEdge = (0x00000000UL);
				smp_adc_1.Init.DMAContinuousRequests = ENABLE;
				smp_adc_1.Init.Overrun = (((0x1UL << (12U))));
       ...
       HAL_ADCEx_Calibration_Start(&smp_adc_1,(( (0x7FUL << (0U)))));
...
uint32_t GetADCChParaSTM32L496(adc_module_number num, GPIO_TypeDef *Port, uint16_t Pin){
	...
	if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)))&&(Pin == ((uint16_t)0x0001))){				    
		return ((((0x01UL << (26U))) | ((0x00000000UL) | (( 3UL) << (20UL))) | ((0x00002UL << (0U))) ));
	}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)))&&(Pin == ((uint16_t)0x0002))){		  
		return ((((0x02UL << (26U))) | ((0x00000000UL) | (( 6UL) << (20UL))) | ((0x00004UL << (0U))) ));
	}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)))&&(Pin == ((uint16_t)0x0004))){		  
		return ((((0x02UL << (26U)) | (0x01UL << (26U))) | ((0x00000000UL) | (( 9UL) << (20UL))) | ((0x00008UL << (0U))) ));
	}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)))&&(Pin == ((uint16_t)0x0008))){		  
		return ((((0x04UL << (26U))) | ((0x00000000UL) | ((12UL) << (20UL))) | ((0x00010UL << (0U))) ));
	}
	if((num == adc1)||(num == adc2)){
		if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0001))){				  
			return ((((0x04UL << (26U)) | (0x01UL << (26U))) | ((0x00000000UL) | ((15UL) << (20UL))) | ((0x00020UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0002))){		
			return ((((0x04UL << (26U)) | (0x02UL << (26U))) | ((0x00000000UL) | ((18UL) << (20UL))) | ((0x00040UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0004))){		
			return ((((0x04UL << (26U)) | (0x02UL << (26U)) | (0x01UL << (26U))) | ((0x00000000UL) | ((21UL) << (20UL))) | ((0x00080UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0008))){		
			return ((((0x08UL << (26U))) | ((0x00000000UL) | ((24UL) << (20UL))) | ((0x00100UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0010))){		
			return ((((0x08UL << (26U)) | (0x01UL << (26U))) | ((0x00000000UL) | ((27UL) << (20UL))) | ((0x00200UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0020))){		
			return ((((0x08UL << (26U)) | (0x02UL << (26U))) | ((0x02000000UL) | (( 0UL) << (20UL))) | ((0x00400UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0040))){		
			return ((((0x08UL << (26U)) | (0x02UL << (26U)) | (0x01UL << (26U))) | ((0x02000000UL) | (( 3UL) << (20UL))) | ((0x00800UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)))&&(Pin == ((uint16_t)0x0080))){		
			return ((((0x08UL << (26U)) | (0x04UL << (26U))) | ((0x02000000UL) | (( 6UL) << (20UL))) | ((0x01000UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)))&&(Pin == ((uint16_t)0x0010))){		
			return ((((0x08UL << (26U)) | (0x04UL << (26U)) | (0x01UL << (26U))) | ((0x02000000UL) | (( 9UL) << (20UL))) | ((0x02000UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)))&&(Pin == ((uint16_t)0x0020))){		
			return ((((0x08UL << (26U)) | (0x04UL << (26U)) | (0x02UL << (26U))) | ((0x02000000UL) | ((12UL) << (20UL))) | ((0x04000UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)))&&(Pin == ((uint16_t)0x0001))){		
			return ((((0x08UL << (26U)) | (0x04UL << (26U)) | (0x02UL << (26U)) | (0x01UL << (26U))) | ((0x02000000UL) | ((15UL) << (20UL))) | ((0x08000UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)))&&(Pin == ((uint16_t)0x0002))){		
			return ((((0x10UL << (26U))) | ((0x02000000UL) | ((18UL) << (20UL))) | ((0x10000UL << (0U)))));
		}
	}else if(num == adc3){
		if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN3)){				
			return ((((0x04UL << (26U)) | (0x02UL << (26U))) | ((0x00000000UL) | ((18UL) << (20UL))) | ((0x00040UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN4)){		
			return ((((0x04UL << (26U)) | (0x02UL << (26U)) | (0x01UL << (26U))) | ((0x00000000UL) | ((21UL) << (20UL))) | ((0x00080UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN5)){		
			return ((((0x08UL << (26U))) | ((0x00000000UL) | ((24UL) << (20UL))) | ((0x00100UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN6)){		
			return ((((0x08UL << (26U)) | (0x01UL << (26U))) | ((0x00000000UL) | ((27UL) << (20UL))) | ((0x00200UL << (0U))) ));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN7)){		
			return ((((0x08UL << (26U)) | (0x02UL << (26U))) | ((0x02000000UL) | (( 0UL) << (20UL))) | ((0x00400UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN8)){		
			return ((((0x08UL << (26U)) | (0x02UL << (26U)) | (0x01UL << (26U))) | ((0x02000000UL) | (( 3UL) << (20UL))) | ((0x00800UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN9)){		
			return ((((0x08UL << (26U)) | (0x04UL << (26U))) | ((0x02000000UL) | (( 6UL) << (20UL))) | ((0x01000UL << (0U)))));
		}else if((Port == ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x1400UL)))&&(Pin == PIN10)){		
			return ((((0x08UL << (26U)) | (0x04UL << (26U)) | (0x01UL << (26U))) | ((0x02000000UL) | (( 9UL) << (20UL))) | ((0x02000UL << (0U)))));
		}	
	}
	return ((0x0) - 2);
