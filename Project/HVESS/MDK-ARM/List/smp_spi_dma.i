...
#line 20 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
...
#line 21 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
...
#line 22 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
#line 23 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
#line 24 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
...
#line 25 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
#line 26 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 27 "..\\..\\..\\Drivers\\SMP\\smp_spi_DMA.c"
...
int8_t smp_spi_master_init(smp_spi_t *p_spi, smp_spi_event_t smp_spi_event_handler, const _Bool lsb)
{
	switch(p_spi->num){
		case SPI_module1:
			...
			smp_spi1_handle.Instance               = ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL));
			smp_spi1_handle.Init.BaudRatePrescaler = ((0x4UL << (3U)) | (0x2UL << (3U)) | (0x1UL << (3U))); 
			smp_spi1_handle.Init.Direction         = (0x00000000U);
			switch(p_spi->mode){
				case SPI_mode0:
					smp_spi1_handle.Init.CLKPolarity  	= (0x00000000U);
					smp_spi1_handle.Init.CLKPhase       = (0x00000000U);  
					break;
				case SPI_mode1:
					smp_spi1_handle.Init.CLKPolarity  	= (0x00000000U); 
					smp_spi1_handle.Init.CLKPhase       = (0x1UL << (0U));  
					break;
				case SPI_mode2:
					smp_spi1_handle.Init.CLKPolarity  	= (0x1UL << (1U)); 
					smp_spi1_handle.Init.CLKPhase       = (0x00000000U); 
					break;
				case SPI_mode3:
					smp_spi1_handle.Init.CLKPolarity  	= (0x1UL << (1U)); 
			...
			smp_spi1_handle.Init.DataSize          = (0x00000700U);
			if(lsb == 1)
				smp_spi1_handle.Init.FirstBit      = (0x1UL << (7U));
			else	
				smp_spi1_handle.Init.FirstBit      = (0x00000000U);
			smp_spi1_handle.Init.TIMode            = (0x00000000U);
			smp_spi1_handle.Init.CRCCalculation    = (0x00000000U);
			smp_spi1_handle.Init.CRCPolynomial     = 7;
			smp_spi1_handle.Init.CRCLength         = (0x00000001U);
			smp_spi1_handle.Init.NSS               = (0x1UL << (9U));
			smp_spi1_handle.Init.NSSPMode          = (0x00000000U);

			smp_spi1_handle.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
			...
			break;
		case SPI_module2:
			do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (14U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (14U)))); (void)tmpreg; } while(0);
			smp_spi2_handle.Instance               = ((SPI_TypeDef *) ((0x40000000UL) + 0x3800UL));
			smp_spi2_handle.Init.BaudRatePrescaler = ((0x4UL << (3U)) | (0x2UL << (3U)) | (0x1UL << (3U))); 
			smp_spi2_handle.Init.Direction         = (0x00000000U);
			switch(p_spi->mode){
				case SPI_mode0:
					smp_spi2_handle.Init.CLKPolarity  	= (0x00000000U);
					smp_spi2_handle.Init.CLKPhase       = (0x00000000U);  
					break;
				case SPI_mode1:
					smp_spi2_handle.Init.CLKPolarity  	= (0x00000000U); 
					smp_spi2_handle.Init.CLKPhase       = (0x1UL << (0U));  
					break;
				case SPI_mode2:
					smp_spi2_handle.Init.CLKPolarity  	= (0x1UL << (1U)); 
					smp_spi2_handle.Init.CLKPhase       = (0x00000000U); 
					break;
				case SPI_mode3:
					smp_spi2_handle.Init.CLKPolarity  	= (0x1UL << (1U)); 
			...
			smp_spi2_handle.Init.DataSize          = (0x00000700U);
			if(lsb == 1)
				smp_spi2_handle.Init.FirstBit      = (0x1UL << (7U));
			else	
				smp_spi2_handle.Init.FirstBit      = (0x00000000U);
			smp_spi2_handle.Init.TIMode            = (0x00000000U);
			smp_spi2_handle.Init.CRCCalculation    = (0x00000000U);
			smp_spi2_handle.Init.CRCPolynomial     = 7;
			smp_spi2_handle.Init.CRCLength         = (0x00000001U);
			smp_spi2_handle.Init.NSS               = (0x1UL << (9U));
			smp_spi2_handle.Init.NSSPMode          = (0x00000000U);

			smp_spi2_handle.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
			...
			break;
		case SPI_module3:
			do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (15U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (15U)))); (void)tmpreg; } while(0);
			smp_spi3_handle.Instance               = ((SPI_TypeDef *) ((0x40000000UL) + 0x3C00UL));
			smp_spi3_handle.Init.BaudRatePrescaler = ((0x4UL << (3U)) | (0x2UL << (3U)) | (0x1UL << (3U))); 
			smp_spi3_handle.Init.Direction         = (0x00000000U);
			switch(p_spi->mode){
				case SPI_mode0:
					smp_spi3_handle.Init.CLKPolarity  	= (0x00000000U);
					smp_spi3_handle.Init.CLKPhase       = (0x00000000U);  
					break;
				case SPI_mode1:
					smp_spi3_handle.Init.CLKPolarity  	= (0x00000000U); 
					smp_spi3_handle.Init.CLKPhase       = (0x1UL << (0U));  
					break;
				case SPI_mode2:
					smp_spi3_handle.Init.CLKPolarity  	= (0x1UL << (1U)); 
					smp_spi3_handle.Init.CLKPhase       = (0x00000000U); 
					break;
				case SPI_mode3:
					smp_spi3_handle.Init.CLKPolarity  	= (0x1UL << (1U)); 
			...
			smp_spi3_handle.Init.DataSize          = (0x00000700U);
			if(lsb == 1)
				smp_spi3_handle.Init.FirstBit      = (0x1UL << (7U));
			else	
				smp_spi3_handle.Init.FirstBit      = (0x00000000U);
			smp_spi3_handle.Init.TIMode            = (0x00000000U);
			smp_spi3_handle.Init.CRCCalculation    = (0x00000000U);
			smp_spi3_handle.Init.CRCPolynomial     = 7;
			smp_spi3_handle.Init.CRCLength         = (0x00000001U);
			smp_spi3_handle.Init.NSS               = (0x1UL << (9U));
			smp_spi3_handle.Init.NSSPMode          = (0x00000000U);

			smp_spi3_handle.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
...
{
  if(h_spi->Instance == ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))){
		spi1_evt_cb(SMP_SPI_EVENT_TRANSFERR_ERROR);
		
	}else if(h_spi->Instance == ((SPI_TypeDef *) ((0x40000000UL) + 0x3800UL))){
		spi2_evt_cb(SMP_SPI_EVENT_TRANSFERR_ERROR);
		
	}else if(h_spi->Instance == ((SPI_TypeDef *) ((0x40000000UL) + 0x3C00UL))){
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==((SPI_TypeDef *) ((0x40000000UL) + 0x3800UL)))
  {
    ...
    hdma_spi2_tx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0058UL));
    hdma_spi2_tx.Init.Request = 1U;
    hdma_spi2_tx.Init.Direction = (0x1UL << (4U));
    hdma_spi2_tx.Init.PeriphInc = 0x00000000U;
    hdma_spi2_tx.Init.MemInc = (0x1UL << (7U));
    ...
    hdma_spi2_tx.Init.Priority = 0x00000000U;
    if (HAL_DMA_Init(&hdma_spi2_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (hspi)->hdmatx = &(hdma_spi2_tx); (hdma_spi2_tx). Parent = (hspi); } while(0);

     
    hdma_spi2_rx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0044UL));
    hdma_spi2_rx.Init.Request = 1U;
    hdma_spi2_rx.Init.Direction = 0x00000000U;
    hdma_spi2_rx.Init.PeriphInc = 0x00000000U;
    hdma_spi2_rx.Init.MemInc = (0x1UL << (7U));
    hdma_spi2_rx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_spi2_rx.Init.MemDataAlignment = 0x00000000U;
    hdma_spi2_rx.Init.Mode = 0x00000000U;
    hdma_spi2_rx.Init.Priority = 0x00000000U;
    if (HAL_DMA_Init(&hdma_spi2_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (hspi)->hdmarx = &(hdma_spi2_rx); (hdma_spi2_rx). Parent = (hspi); } while(0);

   

   
  }
  else if(hspi->Instance==((SPI_TypeDef *) ((0x40000000UL) + 0x3C00UL)))
  {
    ...
    hdma_spi3_tx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x001CUL));
    hdma_spi3_tx.Init.Request = 3U;
    hdma_spi3_tx.Init.Direction = (0x1UL << (4U));
    hdma_spi3_tx.Init.PeriphInc = 0x00000000U;
    hdma_spi3_tx.Init.MemInc = (0x1UL << (7U));
    ...
    hdma_spi3_tx.Init.Priority = 0x00000000U;
    if (HAL_DMA_Init(&hdma_spi3_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (hspi)->hdmatx = &(hdma_spi3_tx); (hdma_spi3_tx). Parent = (hspi); } while(0);

     
    hdma_spi3_rx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL));
    hdma_spi3_rx.Init.Request = 3U;
    hdma_spi3_rx.Init.Direction = 0x00000000U;
    hdma_spi3_rx.Init.PeriphInc = 0x00000000U;
    hdma_spi3_rx.Init.MemInc = (0x1UL << (7U));
    hdma_spi3_rx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_spi3_rx.Init.MemDataAlignment = 0x00000000U;
    hdma_spi3_rx.Init.Mode = 0x00000000U;
    hdma_spi3_rx.Init.Priority = 0x00000000U;
    if (HAL_DMA_Init(&hdma_spi3_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (hspi)->hdmarx = &(hdma_spi3_rx); (hdma_spi3_rx). Parent = (hspi); } while(0);
