...
bsp_adc_init_io_config bsp_in_adc_ch[5]={{. gpio_port= ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , . gpio_pin = ((uint16_t)0x0001) },
                                         {. gpio_port= ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , . gpio_pin = ((uint16_t)0x0002) },
                                         {. gpio_port= ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , . gpio_pin = ((uint16_t)0x0004) },
                                         {. gpio_port= ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)) , . gpio_pin = ((uint16_t)0x0008) },
                                         {. gpio_port= ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)) , . gpio_pin = ((uint16_t)0x0010) },
                                        };
...
#line 112 "..\\..\\..\\API\\ApiScuTemp.c"
	
}
static void scuTempSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
	char	str[100];
