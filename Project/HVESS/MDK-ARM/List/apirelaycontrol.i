...
#line 24 "..\\..\\..\\API\\ApiRelayControl.c"
#line 25 "..\\..\\..\\API\\ApiRelayControl.c"
...
#line 32 "..\\..\\..\\API\\ApiRelayControl.c"

void appSerialCanDavinciSendTextMessage(char *msg);


 
#line 45 "..\\..\\..\\API\\ApiRelayControl.c"
...
static void turnOnRelayProcess(void)
{
	...
	case RELAY_CTRL_PRE_DISCHARGE_DELAY:
		DelayCount++;
		if(DelayCount >= apiSysParGetPreDischargeTime())
		{
			RelayOnStep = RELAY_CTRL_TURN_ON_MAIN_RELAY;
			appSerialCanDavinciSendTextMessage("Main On");
		}
		break;
...
static void checkRelayOn(void)
{
	...
	if((SystemFlag1 & (1U << 31)) == 0)
		return;
	


	if(SystemFlag1 & ((1 << 2) | (1 << 3) | (1 << 6) | (1 << 7) | (1 << 10) | (1 << 13) | (1 << 16) | (1 << 19) | (1 << 20) | (1 << 21) | (1 << 24) | (1 << 25) | (1 << 28) | (1 << 29) | 0))
		return;
	if(SystemFlag2 & (0 | (1 << 3) | (1 << 4) | (1 << 5) | (1 << 6) | 0))
		return;
	...
	appSerialCanDavinciSendTextMessage("On Pre..0");
	if(apiRelayControlFunctionProcessor == 0)
	{
		...
		HalBspRelayPsCtrl(1);
		appSerialCanDavinciSendTextMessage("On Pre..1");
	}
...
static void relayControlSwTimerHandler( void *dest, uint16_t evt, void *vDataPtr)
{
