...
#line 200 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_tsc.c"
...
#line 289 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_tsc.c"
  ...
  htsc->Instance->CR = (0x1UL << (0U));

   
  htsc->Instance->CR |= (htsc->Init.CTPulseHighLength |
                         htsc->Init.CTPulseLowLength |
                         (htsc->Init.SpreadSpectrumDeviation << (17U)) |
  ...
  htsc->Instance->IER &= (~((0x1UL << (0U)) | (0x1UL << (1U))));

   
  htsc->Instance->ICR = ((0x1UL << (0U)) | (0x1UL << (1U)));
...
#line 374 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_tsc.c"
  ...
  do{ (htsc)->Lock = HAL_UNLOCKED; }while (0);
...
#line 600 "..\\..\\..\\Drivers\\STM32L4xx_HAL_Driver\\Src\\stm32l4xx_hal_tsc.c"
...
HAL_StatusTypeDef HAL_TSC_Start(TSC_HandleTypeDef *htsc)
{
  ...
  do{ if((htsc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (htsc)->Lock = HAL_LOCKED; } }while (0);
  ...
  if (htsc->Init.IODefaultMode == 0x00000000UL)
  {
    ((htsc)->Instance ->CR &= (~(0x1UL << (4U))));
  }
  else
  {
    ((htsc)->Instance ->CR |= (0x1UL << (4U)));
...
HAL_StatusTypeDef HAL_TSC_Start_IT(TSC_HandleTypeDef *htsc)
{
  ...
  ((htsc)->Instance ->IER |= ((0x1UL << (0U))));

   
  if (htsc->Init.MaxCountInterrupt == ENABLE)
  {
    ((htsc)->Instance ->IER |= ((0x1UL << (1U))));
  }
  else
  {
    ((htsc)->Instance ->IER &= (~((0x1UL << (1U)))));
...
TSC_GroupStatusTypeDef HAL_TSC_GroupGetStatus(TSC_HandleTypeDef *htsc, uint32_t gx_index)
{
  ...
  return (((((htsc)->Instance ->IOGCSR & (uint32_t)(1UL << (((gx_index) & 0xFUL) + 16UL))) == (uint32_t)(1UL << (((gx_index) & 0xFUL) + 16UL))) ? TSC_GROUP_COMPLETED : TSC_GROUP_ONGOING));
}
...
HAL_TSC_StateTypeDef HAL_TSC_GetState(TSC_HandleTypeDef *htsc)
{
  ...
  if (htsc->State == HAL_TSC_STATE_BUSY)
  {
    ...
    if (((((htsc)->Instance ->ISR & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) ? SET : RESET) != RESET)
    {
       
      if (((((htsc)->Instance ->ISR & ((0x1UL << (1U)))) == ((0x1UL << (1U)))) ? SET : RESET) != RESET)
      {
