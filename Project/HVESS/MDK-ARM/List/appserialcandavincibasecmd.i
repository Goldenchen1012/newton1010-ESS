#line 1 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 19 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 20 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
#line 1 "..\\..\\..\\User\\main.h"
...
#line 21 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 22 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
#line 23 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
#line 1 "..\\..\\..\\HAL\\halafe.h"
...
#line 24 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 25 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
#line 1 "..\\..\\..\\HAL\\HalRtc.h"
...
#line 26 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 27 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
#line 28 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 29 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 30 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 31 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
#line 32 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
#line 1 "..\\..\\..\\APP\\AppBms.h"
...
#line 33 "..\\..\\..\\AppCommunication\\AppSerialCanDavinciBaseCmd.c"
...
static void scuSystemFlag(smp_can_package_t *pCanPkg)
{
	...
	scuid = ((pCanPkg->id >> 18) & 0x7f);
	appBmsSetScuSystemFlag(scuid, ((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))), ((((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+0))))));
}
static void scuCurrent(smp_can_package_t *pCanPkg)
{
	...
	appBmsSetScuCurrent(scuid, 
				(int32_t)((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))), 
				(int32_t)((((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+0))))));
}
...
static void scuVbat(smp_can_package_t *pCanPkg)
{
	...
	scuid = ((pCanPkg->id >> 18) & 0x7f);
	appBmsSetScuVbat(scuid, ((((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[0]+0))))), ((((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+3)))<<24) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+2)))<<16) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+1)))<<8) + (((DWORD)(*(BYTE *)(&pCanPkg->dat[4]+0))))));
}




const tAppSerialSmpCanDecode mDavinciCanBaseRxTxTab[] = {
	{(((uint32_t)0x01<<25)|((uint32_t)0<<18)|((uint32_t)0x00<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)scuIdBrocast},





	{(((uint32_t)0x01<<25)|((uint32_t)0<<18)|((uint32_t)0x01<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)scuSystemFlag},





	{(((uint32_t)0x01<<25)|((uint32_t)0<<18)|((uint32_t)0x03<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)scuCurrent},





	{(((uint32_t)0x01<<25)|((uint32_t)0<<18)|((uint32_t)0x05<<10)|(uint32_t)0), (0xffu << 10), (tAppSerialPacketExe)scuVbat},
