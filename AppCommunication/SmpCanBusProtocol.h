...
#define	SMP_COMMON_RESET_SCU_ID_OBJ_INDEX			0x00
#define	SMP_COMMON_GET_SCUID_OBJ_INDEX				0x01
#define	SMP_COMMON_STOP_ID_ASSIGN_OBJ_INDEX			0x02
...
#define	SMP_RELAY_CONTROL_OBJ_INDEX					0x0B
